...
var requestWithPaging = function requestWithPaging(_ref3) {
  var d2 = _ref3.d2,
      entity = _ref3.entity,
      paramString = _ref3.paramString,
      page = _ref3.page;

  var _ref4 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
      selectorFn = _ref4.selectorFn;
...
var apiFetchDimensions = function apiFetchDimensions(d2, nameProp) {
  ...
  var paramString = "".concat(fields, "&").concat(order);
  return request({
    d2: d2,
    entity: 'dimensions',
...
var apiFetchGroups = function apiFetchGroups(d2, dataType, nameProp) {
  ...
  switch (dataType) {
    ...
    case 'dataSets':
      {
        var dataSetGroups = _dataSets.DATA_SETS_CONSTANTS.map(function (_ref5) {
          var id = _ref5.id,
              name = _ref5.name;
          return {
            id: id,
...
var fetchIndicators = function fetchIndicators(_ref6) {
  var d2 = _ref6.d2,
...
var fetchDataElements = function fetchDataElements(_ref7) {
  var d2 = _ref7.d2,
...
var fetchDataElementOperands = function fetchDataElementOperands(_ref8) {
  var d2 = _ref8.d2,
...
var fetchDataSets = function fetchDataSets(_ref9) {
  var d2 = _ref9.d2,
      page = _ref9.page,
...
var fetchProgramDataElements = function fetchProgramDataElements(_ref10) {
  var d2 = _ref10.d2,
      groupId = _ref10.groupId,
      page = _ref10.page,
      filterText = _ref10.filterText,
      nameProp = _ref10.nameProp;
...
var fetchTrackedEntityAttributes = function fetchTrackedEntityAttributes(_ref11) {
  var d2 = _ref11.d2,
  ...
  return request({
    d2: d2,
    entity: "programs/".concat(groupId),
    paramString: paramString
  }, {
...
function () {
  ...
  _regenerator.default.mark(function _callee(d2, queryParams) {
    var _ref13, _ref14, dataElementsObj, attributes, filterInvalidTypes;
...
var fetchProgramIndicators = function fetchProgramIndicators(_ref15) {
  var d2 = _ref15.d2,
      groupId = _ref15.groupId,
      page = _ref15.page,
      filterText = _ref15.filterText,
      nameProp = _ref15.nameProp;
  var fields = "fields=dimensionItem~rename(id),".concat(nameProp, "~rename(name)");
  var order = "order=".concat(nameProp, ":asc");
