...
const PlaceholderVisualization = () => /*#__PURE__*/_react.default.createElement("div", {
  style: {
    width: '100%',
    height: '100%',
    minHeight: 300,
    ...
    backgroundColor: _ui.colors.grey100,
    border: `1px dashed ${_ui.colors.grey400}`,
    borderRadius: 4,
    color: _ui.colors.grey700,
    fontSize: 14,
    padding: _ui.spacers.dp16
  }
}, "Visualization placeholder");
const ModalDownloadDropdown = () => /*#__PURE__*/_react.default.createElement("div", {
  style: {
    marginTop: _ui.spacers.dp12,
    marginBottom: _ui.spacers.dp16
  }
}, /*#__PURE__*/_react.default.createElement(_ui.DropdownButton, {
  component: /*#__PURE__*/_react.default.createElement("div", null),
  disabled: true,
  open: false,
  secondary: true,
  small: true
}, _d2I18n.default.t('Download data from this date')));
const ModalStory = ({
  interpretation,
...
const NoComments = () => {
  ...
  return /*#__PURE__*/_react.default.createElement(ModalStory, {
...
const WithAFewComments = () => {
  ...
  return /*#__PURE__*/_react.default.createElement(ModalStory, {
    ...
    visualization: {
      id: 'viz-2',
      displayName: 'Penta 3 Immunization Coverage by District Sorted by Participation Rates and Coverage Beyond District Funding Levels - March 2026'
    },
    pluginComponent: PlaceholderVisualization
    // downloadMenuComponent={ModalDownloadDropdown}
    ,
...
const WithManyComments = () => {
  ...
  return /*#__PURE__*/_react.default.createElement(ModalStory, {
    ...
    visualization: {
      id: 'viz-3',
      displayName: 'Acute Watery Diarrhoea Cases - Ashanti Region Weekly Surveillance'
    },
    pluginComponent: PlaceholderVisualization,
    downloadMenuComponent: ModalDownloadDropdown,
    onClose: Function.prototype,
