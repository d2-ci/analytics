...
const stubReplies = (count, prefix) => Array.from({
  length: count
}, (_, i) => ({
  id: `${prefix}-r${i}`
}));
const InterpretationsStory = ({
  ...
  data: {
    interpretations: interpretationsResolver !== null && interpretationsResolver !== void 0 ? interpretationsResolver : {
      interpretations
    }
  }
...
InterpretationsStory.propTypes = {
  ...
  interpretations: _propTypes.default.array,
  interpretationsResolver: _propTypes.default.func
};
const DefaultUnit = props => /*#__PURE__*/_react.default.createElement(_index.InterpretationsUnit, _extends({
  id: "abcd",
...
const Default = () => /*#__PURE__*/_react.default.createElement(InterpretationsStory, null, /*#__PURE__*/_react.default.createElement(DefaultUnit, null));
exports.Default = Default;
const WithNoTimeDimensionsWarning = () => /*#__PURE__*/_react.default.createElement(InterpretationsStory, null, /*#__PURE__*/_react.default.createElement(DefaultUnit, {
...
const Loading = () => /*#__PURE__*/_react.default.createElement(InterpretationsStory, {
...
const DashboardUsage = () => /*#__PURE__*/_react.default.createElement(InterpretationsStory, {
  interpretations: [makeInterpretation({
    id: 'interp-1',
...
}, /*#__PURE__*/_react.default.createElement(DefaultUnit, {
...
const WithOneInterpretation = () => /*#__PURE__*/_react.default.createElement(InterpretationsStory, {
  interpretations: [makeInterpretation({
    id: 'interp-1',
    text: 'The ANC coverage rate has improved steadily across all districts this quarter, with the Eastern region showing the most significant gains. This aligns with the increased outreach activities reported in the monthly summaries.',
    created: '2026-04-10T14:22:00.000',
...
exports.WithOneInterpretation = WithOneInterpretation;
WithOneInterpretation.story = {
  name: 'With one interpretation'
};
const WithInterpretationForCurrentUser = () => /*#__PURE__*/_react.default.createElement(InterpretationsStory, {
  interpretations: [makeInterpretation({
    id: 'interp-short',
...
exports.WithInterpretationForCurrentUser = WithInterpretationForCurrentUser;
WithInterpretationForCurrentUser.story = {
  name: 'With an interpretation for current user'
};
const verboseUserA = 'Prof. Æþelred María-José van Müller‑Wilson ⟨DHIS2⟩ · π≈3.14 — 部署/営業 (ret.)';
const verboseUserB = 'المراجعة الرسمية — O\'Brien & "Søren" Ølsgaard 日本語 [coord.]';
...
const StressTest = () => /*#__PURE__*/_react.default.createElement(InterpretationsStory, {
  containerWidth: 360,
  interpretations: [makeInterpretation({
    id: 'interp-verbose-a',
...
const WithManyInterpretations = () => /*#__PURE__*/_react.default.createElement(InterpretationsStory, {
  interpretations: [makeInterpretation({
    id: 'interp-m01',
...
exports.WithManyInterpretations = WithManyInterpretations;
