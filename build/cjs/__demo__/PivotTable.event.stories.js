...
var _optionsetnovalueData = _interopRequireDefault(require("./data/event/optionsetnovalue.data.json"));
var _optionsetnovalueVisualization = _interopRequireDefault(require("./data/event/optionsetnovalue.visualization.json"));
...
const OptionsetNoValue = (_, {
  pivotTableOptions
}) => {
  const visualization = {
    ..._optionsetnovalueVisualization.default,
    ...visualizationReset,
    ...pivotTableOptions
  };
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    data: _optionsetnovalueData.default,
    visualization: visualization
  }));
};
exports.OptionsetNoValue = OptionsetNoValue;
