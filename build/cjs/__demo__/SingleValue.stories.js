...
(0, _react.storiesOf)('SingleValue', module).add('default', () => {
  ...
  const onOldContainerMounted = (0, _react2.useCallback)(el => {
    (0, _index.createVisualization)(data, layout, el, extraOptions, undefined, undefined, 'dhis');
  }, []);
  const onNewContainerMounted = (0, _react2.useCallback)(el => {
    const obj = (0, _index.createVisualization)(data, layout, el, extraOptions, undefined, undefined, 'singleValue');
  ...
  }), /*#__PURE__*/_react2.default.createElement("div", null, /*#__PURE__*/_react2.default.createElement("div", null, /*#__PURE__*/_react2.default.createElement("label", {
    htmlFor: "width"
