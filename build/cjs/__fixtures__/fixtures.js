...
var _default = exports.default = function x() {
  ...
  addFixture(
      ...
      require('./json/api/organisationUnits.json')
  )
  addFixture('/api/schemas', require('./json/api/schemas.json'))
  addFixture(
      '/api/schemas/dataElement',
      require('./json/api/schemas/dataElement.json')
  )
  addFixture('/api/schemas/dataSet', require('./json/api/schemas/dataSet'))
  addFixture(
      '/api/schemas/indicatorGroup',
      require('./json/api/schemas/indicatorGroup.json')
  )
  addFixture(
      '/api/schemas/organisationUnit',
      require('./json/api/schemas/organisationUnit.json')
  )
  addFixture(
      '/api/schemas/organisationUnitGroupSet',
      require('./json/api/schemas/organisationUnitGroupSet')
  )
  addFixture(
      '/api/schemas/validationRule',
      require('./json/api/schemas/validationRule')
  )
  addFixture('/api/schemas/program', require('./json/api/schemas/program'))
  addFixture(
      '/api/schemas/programNotificationTemplate',
      require('./json/api/schemas/programNotificationTemplate')
  )
  addFixture('/api/schemas/user', require('./json/api/schemas/user.json'))
  addFixture(
      '/api/schemas/legendSet',
      require('./json/api/schemas/legendSet.json')
  )
  ...
  addFixture(
      ...
      require('./json/dataElementAttributes.json')
  )
  ...
  addFixture(
      ...
      require('./json/modelDefinitions/dataElement.json')
  )
  addFixture(
      '/singleUserAllFields',
      require('./json/singleUserAllFields.json')
  )
  addFixture(
      '/singleUserOwnerFields',
      require('./json/singleUserOwnerFields.json')
  )
  addFixture(
      '/api/legendSets/k1JHPfXsJND',
      require('./json/api/legendSets/k1JHPfXsJND.json')
  )
  */
