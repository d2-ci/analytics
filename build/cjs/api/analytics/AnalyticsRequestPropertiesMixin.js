...
class extends base {
  ...
  withAggregationType(value) {
    ...
    const aggregationTypes = new Set(['AVERAGE', 'AVERAGE_SUM_ORG_UNIT', 'COUNT', 'LAST', 'LAST_AVERAGE_ORG_UNIT', 'MIN', 'MAX', 'STDDEV', 'SUM', 'VARIANCE']);
  ...
  withEventStatus(value) {
    ...
    const eventStatuses = new Set(['ACTIVE', 'COMPLETED', 'SCHEDULED', 'OVERDUE', 'SKIPPED']);
...
var _default = exports.default = AnalyticsRequestPropertiesMixin;