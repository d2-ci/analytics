...
var _index2 = require("../RichText/index.js");
...
const AboutAOUnit = /*#__PURE__*/(0, _react.forwardRef)((_ref3, ref) => {
  ...
  const getAccessLevelString = access => {
    ...
    switch (accessMatch.groups.accessLevel) {
      case READ_ONLY:
        return _index.default.t('view only');
      case READ_AND_WRITE:
        return _index.default.t('view and edit');
    }
  };
  const getSharingSummary = ao => {
    ...
    if (re.test(ao.sharing.public)) {
      sharingTextParts.push(_index.default.t('all users ({{accessLevel}})', {
    ...
    Object.values(userAccesses).concat(Object.values(groupAccesses)).forEach(accessRule => {
      sharingTextParts.push(_index.default.t('{{userOrGroup}} ({{accessLevel}})', {
        userOrGroup: accessRule.displayName,
        accessLevel: getAccessLevelString(accessRule.access)
      }));
    });
    return sharingTextParts.length ? _index.default.t('Shared with {{commaSeparatedListOfUsersAndGroups}}', {
      commaSeparatedListOfUsersAndGroups: (0, _list.formatList)(sharingTextParts)
    }) : _index.default.t('Not shared with any users or groups');
  };
  return /*#__PURE__*/_react.default.createElement("div", {
  ...
  }, data.ao.displayDescription ? /*#__PURE__*/_react.default.createElement(_index2.RichTextParser, null, data.ao.displayDescription) : /*#__PURE__*/_react.default.createElement("p", {
    className: `jsx-${_AboutAOUnitStyle.default.__hash}`
  }, _index.default.t('No description'))), /*#__PURE__*/_react.default.createElement("div", {
    className: `jsx-${_AboutAOUnitStyle.default.__hash}`
  ...
  }, _index.default.t('Notifications')), data.ao.subscribed ? /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("p", {
    className: `jsx-${_AboutAOUnitStyle.default.__hash}` + " " + "subscriptionLabel"
  }, _index.default.t("You're subscribed and getting updates about new interpretations.")), /*#__PURE__*/_react.default.createElement(_ui.Button, {
    ...
    loading: unsubscribeIsLoading,
    onClick: unsubscribe
  }, _index.default.t('Unsubscribe'))) : /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("p", {
    className: `jsx-${_AboutAOUnitStyle.default.__hash}` + " " + "subscriptionLabel"
  }, _index.default.t('Subscribe to get updates about new interpretations.')), /*#__PURE__*/_react.default.createElement(_ui.Button, {
    ...
    loading: subscribeIsLoading,
    onClick: subscribe
  }, _index.default.t('Subscribe')))))), /*#__PURE__*/_react.default.createElement(_style.default, {
