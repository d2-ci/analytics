...
const AboutAOUnit = /*#__PURE__*/(0, _react.forwardRef)((_ref3, ref) => {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    className: "jsx-".concat(_AboutAOUnitStyle.default.__hash) + " " + ((0, _classnames.default)('container', {
      expanded: isExpanded
    }) || "")
    ...
    className: "jsx-".concat(_AboutAOUnitStyle.default.__hash) + " " + "loader"
    ...
    className: "jsx-".concat(_AboutAOUnitStyle.default.__hash) + " " + "subsection"
  }, /*#__PURE__*/_react.default.createElement("span", {
    className: "jsx-".concat(_AboutAOUnitStyle.default.__hash) + " " + "subsectionTitle"
    ...
    className: "jsx-".concat(_AboutAOUnitStyle.default.__hash) + " " + "subscriptionLabel"
