...
const getOptions = () => ({
  [_dataTypes.TOTALS]: _d2I18n.default.t('Totals only'),
  [_dataTypes.DETAIL]: _d2I18n.default.t('Details only')
});
...
const DataElementSelector = _ref3 => {
  ...
  }, _d2I18n.default.t('Data elements')), /*#__PURE__*/_react.default.createElement(_ui.InputField, {
    value: searchTerm,
    onChange: onSearchChange,
    placeholder: _d2I18n.default.t('Search by data element name'),
    dense: true,
    type: 'search',
  ...
  }, searchTermRef.current ? _d2I18n.default.t('No data elements found for "{{- searchTerm}}"', {
    searchTerm: searchTermRef.current
  }) : _d2I18n.default.t('No data elements found')), /*#__PURE__*/_react.default.createElement("div", {
