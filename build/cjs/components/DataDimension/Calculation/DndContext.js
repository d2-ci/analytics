...
exports.onActivationKeydown = exports.isInteractiveElement = exports.default = exports.OPTIONS_PANEL = void 0;
...
const isInteractiveElement = el => {
  var _el$closest;
  const match = el === null || el === void 0 || (_el$closest = el.closest) === null || _el$closest === void 0 ? void 0 : _el$closest.call(el, `${INTERACTIVE_SELECTOR}, ${DRAG_CHIP_SELECTOR}`);
...
const onActivationKeydown = callback => e => {
...
exports.onActivationKeydown = onActivationKeydown;
