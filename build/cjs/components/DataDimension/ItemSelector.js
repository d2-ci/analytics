...
var _OptionSetModal = _interopRequireDefault(require("./OptionSet/OptionSetModal.js"));
...
const ItemSelector = _ref5 => {
  ...
  const [currentOptionSet, setCurrentOptionSet] = (0, _react.useState)({});
  ...
  const onChange = selectedIds => {
    const newSelectedItems = selectedIds.map(id => {
      ...
      return {
        ...
        ...(matchingItem.optionSetId ? {
          optionSet: (_matchingItem$optionS = matchingItem.optionSet) !== null && _matchingItem$optionS !== void 0 ? _matchingItem$optionS : {
            id: matchingItem.optionSetId,
            options: [],
            aggregation: undefined
          }
        } : {}),
  ...
  // must read from selectedItems, the base option does not have the optionSet object
  const getOptionSet = dataItemId => {
    var _selectedItems$find;
    return (_selectedItems$find = selectedItems.find(item => item.value === dataItemId)) === null || _selectedItems$find === void 0 ? void 0 : _selectedItems$find.optionSet;
  };
  const onEditClick = dataItem => {
    var _dataItem$access;
    const dataItemType = getItemType(dataItem.value);
    if (dataItemType === _dataTypes.DIMENSION_TYPE_EXPRESSION_DIMENSION_ITEM && !(((_dataItem$access = dataItem.access) === null || _dataItem$access === void 0 ? void 0 : _dataItem$access.write) === false) && state.supportsEDI) {
      // calculation
      ...
      const optionSet = getOptionSet(dataItem.value);
      if (optionSet !== null && optionSet !== void 0 && optionSet.id) {
        // option set
        setCurrentOptionSet({
          ...optionSet,
          dataItem: {
  ...
  const onSaveOptionSet = _ref11 => {
    ...
    selectedItems.splice(selectedItemIndex, 1, updatedDataItem);
    onSelect(selectedItems);
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    /* eslint-disable react/prop-types */, _extends({}, props, {
      optionSet: props.optionSetId && getOptionSet(props.value),
    ...
    displayNameProp: displayNameProp
  }), (currentOptionSet === null || currentOptionSet === void 0 ? void 0 : currentOptionSet.id) && /*#__PURE__*/_react.default.createElement(_OptionSetModal.default, _extends({}, currentOptionSet, {
    displayNameProp: displayNameProp,
    onClose: () => setCurrentOptionSet(),
    onSave: onSaveOptionSet
...
ItemSelector.propTypes = {
  ...
  onOptionSetSave: _propTypes.default.func
};
