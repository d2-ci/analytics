...
var _index = require("../modules/layoutUiRules/index.js");
...
const getAxisItemLabel = (axisName, isDimensionInLayout) => isDimensionInLayout ? _d2I18n.default.t('Move to {{axisName}}', {
  axisName
...
const getUnavailableLabel = visType => _d2I18n.default.t('Not available for {{visualizationType}}', {
...
const DimensionMenu = _ref => {
  ...
  const availableAxisIds = (0, _index.getAvailableAxes)(visType);
  const applicableAxisIds = availableAxisIds.filter(axisId => axisId !== currentAxisId);
  const assignedCategoriesAvailableDestinations = (0, _index.getAvailableAxes)(visType).filter(axis => axis !== _axis2.AXIS_ID_FILTERS);
  const assignedCategoriesItemLabel = isAssignedCategoriesInLayout ? _d2I18n.default.t('Remove Assigned Categories') : _d2I18n.default.t('Add Assigned Categories');
  const getRemoveMenuItem = onClick => /*#__PURE__*/_react.default.createElement(_ui.MenuItem, {
    key: "remove-menu-item",
    onClick: onClick,
    label: _d2I18n.default.t('Remove'),
