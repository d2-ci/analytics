...
const DynamicDimension = _ref => {
  ...
  const selectAutomatic = () => onSelect({
    ...
    items: [{
      ...
      name: _d2I18n.default.t('All items')
    }, ...selectedItems]
  });
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_ui.Field, {
    ...
    className: `jsx-${_DynamicDimensionStyle.default.__hash}` + " " + "automatic"
  }, /*#__PURE__*/_react.default.createElement(_ui.Radio, {
    key: 'AUTOMATIC',
    label: _d2I18n.default.t('Automatically include all items'),
    dense: true,
    onChange: () => selectAutomatic(),
    checked: allIsSelected,
    dataTest: 'dynamic-dimension-selection-type-automatic'
  }), /*#__PURE__*/_react.default.createElement("p", {
    className: `jsx-${_DynamicDimensionStyle.default.__hash}` + " " + "help-text"
  }, _d2I18n.default.t('Select all {{- dimensionTitle}} items. With this option, new items added in the future will be automatically included.', {
    dimensionTitle
  }))), /*#__PURE__*/_react.default.createElement("div", {
    className: `jsx-${_DynamicDimensionStyle.default.__hash}` + " " + "manual"
  }, /*#__PURE__*/_react.default.createElement(_ui.Radio, {
    key: 'MANUAL',
    label: _d2I18n.default.t('Manually select items...'),
    dense: true,
    ...
    noItemsMessage: _d2I18n.default.t('Nothing found in {{- dimensionTitle}}', {
      dimensionTitle
    }),
    onFetch: fetchItems,
    onSelect: onSelectItems,
    rightFooter: rightFooter,
    dataTest: `${dimensionTitle.replace(/\s+/g, '-').toLowerCase()}-dimension`
