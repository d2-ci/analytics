...
const SaveAsDialog = _ref => {
  ...
  const [name, setName] = (0, _react.useState)(object !== null && object !== void 0 && object.displayName || object !== null && object !== void 0 && object.name ? _d2I18n.default.t('{{- objectName}} (copy)', {
  ...
  return /*#__PURE__*/_react.default.createElement(_ui.Modal, {
  ...
  }, _FileMenuStyles.modalStyles), /*#__PURE__*/_react.default.createElement(_ui.ModalTitle, null, _d2I18n.default.t('Save {{fileType}} as', {
    ...
    label: _d2I18n.default.t('Description'),
    value: description,
    rows: 3,
    onChange: _ref3 => {
      let {
