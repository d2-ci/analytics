...
const CommentAddForm = _ref => {
  ...
  const inputPlaceholder = _index.default.t('Write a reply');
  return /*#__PURE__*/_react.default.createElement(_index3.MessageEditorContainer, {
    ...
    loading: loading
  }, _index.default.t('Post reply')), /*#__PURE__*/_react.default.createElement(_ui.Button, {
    secondary: true,
    small: true,
    disabled: loading,
    onClick: () => {
  ...
  }, _index.default.t('Cancel')))) : /*#__PURE__*/_react.default.createElement(_index3.MessageInput, {
