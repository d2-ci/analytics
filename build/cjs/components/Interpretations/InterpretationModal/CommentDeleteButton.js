...
var _useConfirmClick = require("../common/useConfirmClick.js");
...
const CommentDeleteButton = ({
  ...
  const {
    isConfirming,
    onClick
  } = (0, _useConfirmClick.useConfirmClick)(remove);
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    tooltipContent: isConfirming ? _d2I18n.default.t('Click again to delete') : _d2I18n.default.t('Delete'),
    iconComponent: _ui.IconDelete16,
    label: isConfirming ? _d2I18n.default.t('Delete?') : undefined,
