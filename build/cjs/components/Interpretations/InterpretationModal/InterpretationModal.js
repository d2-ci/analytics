...
const InterpretationModal = ({
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, loadingInProgress && /*#__PURE__*/_react.default.createElement(_ui.Layer, null, /*#__PURE__*/_react.default.createElement(_ui.CenteredContent, null, /*#__PURE__*/_react.default.createElement(_ui.CircularLoader, null))), /*#__PURE__*/_react.default.createElement(_ui.Modal, {
    ...
    className: _style.default.dynamic([["2882349382", [_ui.colors.grey900, _ui.spacers.dp4, _ui.spacers.dp4]]]) + " " + "title"
  }, interpretation !== null && interpretation !== void 0 && interpretation.created ? _d2I18n.default.t('Viewing interpretation data from {{- interpretationDate}}', {
    interpretationDate: (0, _moment.default)(fromServerDate(interpretation.created)).format('LL'),
    nsSeparator: '^^'
  }) : _d2I18n.default.t('Viewing interpretation data')), /*#__PURE__*/_react.default.createElement(_ui.ModalContent, {
    className: modalContentCSS.className
  }, /*#__PURE__*/_react.default.createElement("div", {
    className: _style.default.dynamic([["2882349382", [_ui.colors.grey900, _ui.spacers.dp4, _ui.spacers.dp4]]]) + " " + "container"
    ...
    className: _style.default.dynamic([["2882349382", [_ui.colors.grey900, _ui.spacers.dp4, _ui.spacers.dp4]]]) + " " + "row"
  }, /*#__PURE__*/_react.default.createElement("div", {
    className: _style.default.dynamic([["2882349382", [_ui.colors.grey900, _ui.spacers.dp4, _ui.spacers.dp4]]]) + " " + "visualisation-wrap"
    ...
    isInModal: true,
    className: _style.default.dynamic([["2882349382", [_ui.colors.grey900, _ui.spacers.dp4, _ui.spacers.dp4]]])
  })), /*#__PURE__*/_react.default.createElement("div", {
    className: _style.default.dynamic([["2882349382", [_ui.colors.grey900, _ui.spacers.dp4, _ui.spacers.dp4]]]) + " " + "thread-wrap"
    ...
    disabled: loading,
    onClick: onClose
  }, _d2I18n.default.t('Close'))), modalCSS.styles, modalContentCSS.styles, /*#__PURE__*/_react.default.createElement(_style.default, {
    id: "2882349382",
    dynamic: [_ui.colors.grey900, _ui.spacers.dp4, _ui.spacers.dp4]
  }, [`.title.__jsx-style-dynamic-selector{color:${_ui.colors.grey900};margin:0 0 ${_ui.spacers.dp4} 0;padding:0 0 ${_ui.spacers.dp4};font-size:16px;font-weight:500;line-height:21px;}`, ".container.__jsx-style-dynamic-selector{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-flex-direction:column;-ms-flex-direction:column;flex-direction:column;height:100%;}", ".row.__jsx-style-dynamic-selector{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-flex-direction:row;-ms-flex-direction:row;flex-direction:row;gap:16px;height:100%;}", ".visualisation-wrap.__jsx-style-dynamic-selector{-webkit-box-flex:1;-webkit-flex-grow:1;-ms-flex-positive:1;flex-grow:1;min-width:0;}", ".thread-wrap.__jsx-style-dynamic-selector{-webkit-flex-basis:300px;-ms-flex-preferred-size:300px;flex-basis:300px;-webkit-flex-shrink:0;-ms-flex-negative:0;flex-shrink:0;}"])));
};
