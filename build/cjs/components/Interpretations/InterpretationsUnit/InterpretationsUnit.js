...
const InterpretationsUnit = ({
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    className: _style.default.dynamic([["515377163", [_ui.spacers.dp16, _ui.colors.white, _ui.spacers.dp24, _ui.spacers.dp12, _ui.colors.grey900]]]) + " " + ((0, _classnames.default)('container', {
      expanded: isExpanded
    }) || "")
  }, /*#__PURE__*/_react.default.createElement("button", {
    onClick: () => setIsExpanded(!isExpanded),
    className: _style.default.dynamic([["515377163", [_ui.spacers.dp16, _ui.colors.white, _ui.spacers.dp24, _ui.spacers.dp12, _ui.colors.grey900]]]) + " " + "header"
  }, /*#__PURE__*/_react.default.createElement("span", {
    className: _style.default.dynamic([["515377163", [_ui.spacers.dp16, _ui.colors.white, _ui.spacers.dp24, _ui.spacers.dp12, _ui.colors.grey900]]]) + " " + "title"
    ...
    className: _style.default.dynamic([["515377163", [_ui.spacers.dp16, _ui.colors.white, _ui.spacers.dp24, _ui.spacers.dp12, _ui.colors.grey900]]]) + " " + "loader"
    ...
    id: "515377163",
    dynamic: [_ui.spacers.dp16, _ui.colors.white, _ui.spacers.dp24, _ui.spacers.dp12, _ui.colors.grey900]
  }, [`.container.__jsx-style-dynamic-selector{position:relative;padding:${_ui.spacers.dp16};background-color:${_ui.colors.white};}`, `.expanded.__jsx-style-dynamic-selector{padding-block-end:${_ui.spacers.dp24};}`, ".loader.__jsx-style-dynamic-selector{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-box-pack:center;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;}", `.header.__jsx-style-dynamic-selector{all:unset;inline-size:100%;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-box-pack:justify;-webkit-justify-content:space-between;-ms-flex-pack:justify;justify-content:space-between;cursor:pointer;margin-block-end:${_ui.spacers.dp12};}`, `.title.__jsx-style-dynamic-selector{font-size:16px;font-weight:500;line-height:21px;color:${_ui.colors.grey900};}`]));
};
