...
const Interpretation = _ref => {
  ...
  const interpretationAccess = (0, _index2.getInterpretationAccess)(interpretation, currentUser);
  let tooltip = _index.default.t('Reply');
  if (!interpretationAccess.comment) {
    if (isInThread) {
      tooltip = _index.default.t('{{count}} replies', {
        count: interpretation.comments.length,
        defaultValue: '{{count}} reply',
        defaultValue_plural: '{{count}} replies'
      });
    } else {
      tooltip = _index.default.t('View replies');
    }
  }
  ...
  }) : /*#__PURE__*/_react.default.createElement(_index2.Message, {
    text: interpretation.text,
    created: interpretation.created,
    username: interpretation.createdBy.displayName
  }, !disabled && /*#__PURE__*/_react.default.createElement(_index2.MessageStatsBar, null, /*#__PURE__*/_react.default.createElement(_index2.MessageIconButton, {
    tooltipContent: isLikedByCurrentUser ? _index.default.t('Unlike') : _index.default.t('Like'),
  ...
  }), /*#__PURE__*/_react.default.createElement(_index2.MessageIconButton, {
  ...
  }), dashboardRedirectUrl && !isInThread && /*#__PURE__*/_react.default.createElement(_index2.MessageIconButton, {
    tooltipContent: _index.default.t('See interpretation'),
    iconComponent: _ui.IconView16,
    onClick: () => onClick(interpretation.id),
    dataTest: "interpretation-view-button"
  }), dashboardRedirectUrl && /*#__PURE__*/_react.default.createElement(_index2.MessageIconButton, {
    tooltipContent: _index.default.t('Open in app'),
  ...
  }), interpretationAccess.share && /*#__PURE__*/_react.default.createElement(_index2.MessageIconButton, {
    iconComponent: _ui.IconShare16,
    tooltipContent: _index.default.t('Share'),
  ...
  }), /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, interpretationAccess.edit && /*#__PURE__*/_react.default.createElement(_index2.MessageIconButton, {
    iconComponent: _ui.IconEdit16,
    tooltipContent: _index.default.t('Edit'),
  ...
  }, _index.default.t('See interpretation')));
};
