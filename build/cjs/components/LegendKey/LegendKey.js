...
const LegendKey = _ref => {
  ...
  return legendSets.length ? /*#__PURE__*/_react.default.createElement("div", {
    ...
    className: "jsx-".concat(_LegendKeyStyle.default.__hash) + " " + "legend"
  }, /*#__PURE__*/_react.default.createElement("span", {
    className: "jsx-".concat(_LegendKeyStyle.default.__hash)
  }, legend.name), /*#__PURE__*/_react.default.createElement("span", {
    className: "jsx-".concat(_LegendKeyStyle.default.__hash) + " " + "values"
  }, "".concat(legend.startValue, "-<").concat(legend.endValue)))))), /*#__PURE__*/_react.default.createElement(_style.default, {
