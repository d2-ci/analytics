...
const OpenFileDialog = _ref2 => {
  ...
  const headers = [{
    ...
    field: 'created',
    label: _index.default.t('Created'),
    width: '110px'
  }, {
    field: 'lastUpdated',
    label: _index.default.t('Last updated'),
    width: '110px'
  }];
  if (filterVisTypes !== null && filterVisTypes !== void 0 && filterVisTypes.length) {
    headers.splice(1, 0, {
      field: 'type',
      label: _index.default.t('Type'),
      width: '60px'
    });
  }
  ...
  return /*#__PURE__*/_react.default.createElement(_ui.Modal, {
    ...
    secondary: true,
    small: true
  }, _index.default.t('Clear filters'))), error ? /*#__PURE__*/_react.default.createElement(_ui.NoticeBox, {
