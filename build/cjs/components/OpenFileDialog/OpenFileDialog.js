...
const OpenFileDialog = _ref2 => {
  ...
  return /*#__PURE__*/_react.default.createElement(_ui.Modal, {
    ...
    className: "jsx-".concat(_OpenFileDialogStyles.styles.__hash) + " " + "search-and-filter-bar"
  }, /*#__PURE__*/_react.default.createElement("div", {
    className: "jsx-".concat(_OpenFileDialogStyles.styles.__hash) + " " + "search-field-container"
    ...
    className: "jsx-".concat(_OpenFileDialogStyles.styles.__hash) + " " + "info-text"
    ...
    className: "jsx-".concat(_OpenFileDialogStyles.styles.__hash) + " " + "info-container"
    ...
    className: "jsx-".concat(_OpenFileDialogStyles.styles.__hash) + " " + "info-button"
