...
const RightHeader = _ref => {
  ...
  }, _d2I18n.default.t('Selected Periods')), infoBoxMessage && /*#__PURE__*/_react.default.createElement("div", {
...
const PeriodTransfer = _ref2 => {
  ...
  const defaultRelativePeriodType = excludedPeriodTypes.includes(_index.MONTHLY) ? (0, _relativePeriods.getRelativePeriodsOptionsById)(_index.QUARTERLY) : (0, _relativePeriods.getRelativePeriodsOptionsById)(_index.MONTHLY);
  const defaultFixedPeriodType = excludedPeriodTypes.includes(_index.MONTHLY) ? (0, _fixedPeriods.getFixedPeriodsOptionsById)(_index.QUARTERLY, periodsSettings) : (0, _fixedPeriods.getFixedPeriodsOptionsById)(_index.MONTHLY, periodsSettings);
  ...
  }, _d2I18n.default.t('Relative periods')), /*#__PURE__*/_react.default.createElement(_ui.Tab, {
    selected: !isRelative,
    onClick: () => onIsRelativeClick(false),
    dataTest: `${dataTest}-fixed-periods-button`
  }, _d2I18n.default.t('Fixed periods'))), /*#__PURE__*/_react.default.createElement("div", {
  ...
  }, _d2I18n.default.t('No periods selected')), /*#__PURE__*/_react.default.createElement(_style.default, {
    id: _DimensionSelectorStyle.default.__hash
  }, _DimensionSelectorStyle.default));
