...
describe('fixedPeriods utils', () => {
  ...
  describe('getOptions', () => {
    it('should return a list of available period ranges', () => {
      ...
      expect(periodIds).toEqual(['DAILY', 'WEEKLY', 'WEEKLYWED', 'WEEKLYTHU', 'WEEKLYSAT', 'WEEKLYSUN', 'BIWEEKLY', 'MONTHLY', 'BIMONTHLY', 'QUARTERLY', 'SIXMONTHLY', 'SIXMONTHLYAPR', 'YEARLY', 'FYJAN', 'FYFEB', 'FYMAR', 'FYAPR', 'FYMAY', 'FYJUN', 'FYJUL', 'FYAUG', 'FYSEP', 'FYOCT', 'FYNOV', 'FYDEC']);
    });
  });
  describe('Daily period generator', () => {
    let periods;
    beforeAll(() => {
      const option = (0, _fixedPeriods.getFixedPeriodsOptionsById)('DAILY');
  ...
  describe('Weekly period generator', () => {
    let periods;
    beforeAll(() => {
      const option = (0, _fixedPeriods.getFixedPeriodsOptionsById)('WEEKLY');
      periods = option.getPeriods({
    ...
    describe('-> Weekly Wednesday', () => {
      beforeAll(() => {
        const option = (0, _fixedPeriods.getFixedPeriodsOptionsById)('WEEKLYWED');
        periods = option.getPeriods({
          offset: 2019 - new Date(Date.now()).getFullYear(),
          filterFuturePeriods: false,
          reversePeriods: false
    ...
    describe('-> Weekly Thursday', () => {
      beforeAll(() => {
        const option = (0, _fixedPeriods.getFixedPeriodsOptionsById)('WEEKLYTHU');
        periods = option.getPeriods({
          offset: 2019 - new Date(Date.now()).getFullYear(),
          filterFuturePeriods: false,
          reversePeriods: false
    ...
    describe('-> Weekly Saturday', () => {
      beforeAll(() => {
        const option = (0, _fixedPeriods.getFixedPeriodsOptionsById)('WEEKLYSAT');
        periods = option.getPeriods({
          offset: 2019 - new Date(Date.now()).getFullYear(),
          filterFuturePeriods: false,
          reversePeriods: false
    ...
    describe('-> Weekly Sunday', () => {
      beforeAll(() => {
        const option = (0, _fixedPeriods.getFixedPeriodsOptionsById)('WEEKLYSUN');
        periods = option.getPeriods({
          offset: 2019 - new Date(Date.now()).getFullYear(),
          filterFuturePeriods: false,
          reversePeriods: false
  ...
  describe('Bi-weekly period generator', () => {
    let periods;
    beforeAll(() => {
      const option = (0, _fixedPeriods.getFixedPeriodsOptionsById)('BIWEEKLY');
      periods = option.getPeriods({
        offset: 2019 - new Date(Date.now()).getFullYear(),
        filterFuturePeriods: false,
        reversePeriods: false
  ...
  describe('Monthly period generator', () => {
    let periods;
    beforeAll(() => {
      const option = (0, _fixedPeriods.getFixedPeriodsOptionsById)('MONTHLY');
      periods = option.getPeriods({
        offset: 2019 - new Date(Date.now()).getFullYear(),
        filterFuturePeriods: false,
        reversePeriods: false
  ...
  describe('Bi-Monthly period generator', () => {
    let periods;
    beforeAll(() => {
      const option = (0, _fixedPeriods.getFixedPeriodsOptionsById)('BIMONTHLY');
      periods = option.getPeriods({
        offset: 2019 - new Date(Date.now()).getFullYear(),
        filterFuturePeriods: false,
        reversePeriods: false
  ...
  describe('Quarterly period generator', () => {
    let periods;
    beforeAll(() => {
      const option = (0, _fixedPeriods.getFixedPeriodsOptionsById)('QUARTERLY');
      periods = option.getPeriods({
        offset: 2019 - new Date(Date.now()).getFullYear(),
        filterFuturePeriods: false,
        reversePeriods: false
  ...
  describe('Six-monthly period generator', () => {
    let periods;
    beforeAll(() => {
      const option = (0, _fixedPeriods.getFixedPeriodsOptionsById)('SIXMONTHLY');
      periods = option.getPeriods({
        offset: 2019 - new Date(Date.now()).getFullYear(),
        filterFuturePeriods: false,
        reversePeriods: false
  ...
  describe('Six-monthly April period generator', () => {
    let periods;
    beforeAll(() => {
      const option = (0, _fixedPeriods.getFixedPeriodsOptionsById)('SIXMONTHLYAPR');
      periods = option.getPeriods({
        offset: 2019 - new Date(Date.now()).getFullYear(),
        filterFuturePeriods: false,
        reversePeriods: false
  ...
  describe('Yearly period generator', () => {
    let periods;
    beforeAll(() => {
      const option = (0, _fixedPeriods.getFixedPeriodsOptionsById)('YEARLY');
      periods = option.getPeriods({
        offset: 10,
        // 2020 - 2029
        filterFuturePeriods: false,
  ...
  describe('Financial November period generator', () => {
    let periods;
    beforeAll(() => {
      const option = (0, _fixedPeriods.getFixedPeriodsOptionsById)('FYNOV');
      periods = option.getPeriods({
        offset: 9,
        filterFuturePeriods: false,
        reversePeriods: false
  ...
  describe('Financial October period generator', () => {
    let periods;
    beforeAll(() => {
      const option = (0, _fixedPeriods.getFixedPeriodsOptionsById)('FYOCT');
      periods = option.getPeriods({
        offset: 9,
        filterFuturePeriods: false,
        reversePeriods: false
  ...
  describe('Financial July period generator', () => {
    let periods;
    beforeAll(() => {
      const option = (0, _fixedPeriods.getFixedPeriodsOptionsById)('FYJUL');
      periods = option.getPeriods({
        offset: 9,
        filterFuturePeriods: false,
        reversePeriods: false
  ...
  describe('Financial April period generator', () => {
    let periods;
    beforeAll(() => {
      const option = (0, _fixedPeriods.getFixedPeriodsOptionsById)('FYAPR');
      periods = option.getPeriods({
        offset: 9,
        filterFuturePeriods: false,
        reversePeriods: false
