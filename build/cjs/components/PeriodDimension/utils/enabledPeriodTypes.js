...
exports.findBestAvailableRelativePeriod = exports.filterEnabledRelativePeriodTypes = exports.filterEnabledFixedPeriodTypes = exports.SERVER_PT_TO_MULTI_CALENDAR_PT = exports.RP_CATEGORY_TO_FP_DEPENDENCIES = exports.ANALYSIS_RELATIVE_PERIOD_MAPPING = void 0;
...
const RP_CATEGORY_TO_FP_DEPENDENCIES = exports.RP_CATEGORY_TO_FP_DEPENDENCIES = {
  DAILY: ['Daily'],
  WEEKLY: ['Weekly', 'WeeklyMonday', 'WeeklyTuesday', 'WeeklyWednesday', 'WeeklyThursday', 'WeeklyFriday', 'WeeklySaturday', 'WeeklySunday'],
  BIWEEKLY: ['BiWeekly'],
  MONTHLY: ['Monthly'],
  BIMONTHLY: ['BiMonthly'],
  QUARTERLY: ['Quarterly', 'QuarterlyJan', 'QuarterlyFeb', 'QuarterlyMar', 'QuarterlyApr', 'QuarterlyMay', 'QuarterlyJun', 'QuarterlyJul', 'QuarterlyAug', 'QuarterlySep', 'QuarterlyOct', 'QuarterlyNov', 'QuarterlyDec'],
  SIXMONTHLY: ['SixMonthly', 'SixMonthlyJan', 'SixMonthlyFeb', 'SixMonthlyMar', 'SixMonthlyApril', 'SixMonthlyMay', 'SixMonthlyJun', 'SixMonthlyJul', 'SixMonthlyAug', 'SixMonthlySep', 'SixMonthlyOct', 'SixMonthlyNov', 'SixMonthlyDec'],
  YEARLY: ['Yearly']
};
...
const ANALYSIS_RELATIVE_PERIOD_MAPPING = exports.ANALYSIS_RELATIVE_PERIOD_MAPPING = {
  THIS_WEEK: {
    id: 'THIS_WEEK',
    category: 'WEEKLY'
  },
...
const RP_CATEGORY_FALLBACK_ORDER = ['MONTHLY',
// Most common
'QUARTERLY',
// Close alternative to monthly
'YEARLY',
// Longer term view
'WEEKLY',
// More granular
 ...
 */
const findBestAvailableRelativePeriod = (enabledRelativeOptions, analysisRelativePeriod) => {
  var _firstCategory$getPer;
  ...
  for (const categoryId of RP_CATEGORY_FALLBACK_ORDER) {
    if (enabledCategoryIds.has(categoryId)) {
      ...
      const periods = (categoryOption === null || categoryOption === void 0 ? void 0 : categoryOption.getPeriods()) || [];
      const defaultPeriod = periods[0];
      return {
        categoryId,
        periodId: (defaultPeriod === null || defaultPeriod === void 0 ? void 0 : defaultPeriod.id) || null
      };
    }
  }
  ...
  const firstPeriod = firstCategory === null || firstCategory === void 0 ? void 0 : (_firstCategory$getPer = firstCategory.getPeriods()) === null || _firstCategory$getPer === void 0 ? void 0 : _firstCategory$getPer[0];
  return {
    categoryId: (firstCategory === null || firstCategory === void 0 ? void 0 : firstCategory.id) || null,
    periodId: (firstPeriod === null || firstPeriod === void 0 ? void 0 : firstPeriod.id) || null
  };
};
exports.findBestAvailableRelativePeriod = findBestAvailableRelativePeriod;