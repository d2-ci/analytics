...
}) => /*#__PURE__*/_react.default.createElement("tbody", null, /*#__PURE__*/_react.default.createElement(_PivotTableClippedAxis.PivotTableClippedAxis, {
  axisClippingResult: clippingResult.rows,
  EmptyComponent: ({
    size
  }) => /*#__PURE__*/_react.default.createElement(_PivotTableEmptyRow.PivotTableEmptyRow, {
    height: size,
    columns: clippingResult.columns.indices
  }),
  ItemComponent: ({
    index
  }) => /*#__PURE__*/_react.default.createElement(_PivotTableRow.PivotTableRow, {
    key: index,
