...
const PivotTableSortIcon = _ref => {
  ...
  return /*#__PURE__*/_react.default.createElement("span", {
    className: "jsx-".concat(_PivotTableStyle.sortIcon.__hash) + " " + "fontsize-".concat(engine.visualization.fontSize)
  }, /*#__PURE__*/_react.default.createElement(_style.default, {
    id: _PivotTableStyle.sortIcon.__hash
  }, _PivotTableStyle.sortIcon), /*#__PURE__*/_react.default.createElement(SortIcon, {
    className: "jsx-".concat(_PivotTableStyle.sortIcon.__hash)
  }));
};
