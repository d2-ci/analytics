...
const Toolbar = _ref4 => {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    tooltipContent: _index.default.t('Bold text'),
    disabled: disabled,
    ...
    tooltipContent: _index.default.t('Italic text'),
    disabled: disabled,
    ...
    tooltipContent: _index.default.t('Link to a URL'),
    disabled: disabled,
    ...
    tooltipContent: _index.default.t('Mention a user'),
    disabled: disabled,
    ...
    tooltipContent: _index.default.t('Add emoji'),
    disabled: disabled,
  ...
  }, _index.default.t('Preview')))) : /*#__PURE__*/_react.default.createElement("div", {
    ...
    onClick: onTogglePreview,
    disabled: disabled
  }, _index.default.t('Back to write mode'))), /*#__PURE__*/_react.default.createElement(_style.default, {
    id: _EditorStyle.tooltipAnchorClasses.__hash
