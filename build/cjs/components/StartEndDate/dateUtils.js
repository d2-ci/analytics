...
exports.nextCharIsManualHyphen = exports.nextCharIsAutoHyphen = exports.getMaxMonthsInYear = exports.getMaxDaysInMonth = exports.getDefaultDatesInCalendar = exports.getCurrentYearInCalendar = exports.formatDateOnBlur = exports.formatDateInput = exports.DEFAULT_PLACEHOLDER = exports.DEFAULT_CALENDAR = void 0;
exports.replaceAt = replaceAt;
var _multiCalendarDates = require("@dhis2/multi-calendar-dates");
var _polyfill = require("@js-temporal/polyfill");
// 13th months in etiopic calendar cannot be returned by getFixedPeriodByDate (@dhis2/multi-calendar-dates)

const DEFAULT_CALENDAR = exports.DEFAULT_CALENDAR = 'iso8601';
const DEFAULT_PLACEHOLDER = exports.DEFAULT_PLACEHOLDER = 'yyyy-mm-dd';
...
const getMaxDaysInMonth = (year, month, calendar) => {
...
exports.getMaxDaysInMonth = getMaxDaysInMonth;
const getMaxMonthsInYear = (year, calendar) => {
  if (calendar === NEPALI_CALENDAR_NAME) {
...
exports.getMaxMonthsInYear = getMaxMonthsInYear;
const getDefaultDatesInCalendar = (calendar = DEFAULT_CALENDAR) => {
  const calendarName = dhis2CalendarsMap[calendar] || calendar;
  const {
    day,
    month,
    eraYear: year
  } = (0, _multiCalendarDates.getNowInCalendar)(calendarName);
...
exports.getDefaultDatesInCalendar = getDefaultDatesInCalendar;
const getCurrentYearInCalendar = calendar => {
  const calendarName = dhis2CalendarsMap[calendar] || calendar;
  const today = (0, _multiCalendarDates.getNowInCalendar)(calendarName);
  return today.eraYear;
};
exports.getCurrentYearInCalendar = getCurrentYearInCalendar;
...
exports.formatDateOnBlur = formatDateOnBlur;
const nextCharIsAutoHyphen = ({
  date,
  prevDate,
  caret
}) => {
...
exports.nextCharIsAutoHyphen = nextCharIsAutoHyphen;
const nextCharIsManualHyphen = ({
  date,
  prevDate,
  caret
}) => {
...
exports.nextCharIsManualHyphen = nextCharIsManualHyphen;