...
const getAxisNamesByLayoutType = layoutType => {
  switch (layoutType) {
    ...
    default:
      return {
        [_axis.AXIS_ID_COLUMNS]: _d2I18n.default.t('Series'),
        [_axis.AXIS_ID_ROWS]: _d2I18n.default.t('Category'),
        [_axis.AXIS_ID_FILTERS]: _d2I18n.default.t('Filter')
      };
    case _layoutTypes.LAYOUT_TYPE_PIVOT_TABLE:
      return {
        [_axis.AXIS_ID_COLUMNS]: _d2I18n.default.t('Columns'),
        [_axis.AXIS_ID_ROWS]: _d2I18n.default.t('Rows'),
        [_axis.AXIS_ID_FILTERS]: _d2I18n.default.t('Filter')
      };
    ...
    case _layoutTypes.LAYOUT_TYPE_SCATTER:
      return {
        [_axis.AXIS_ID_ROWS]: _d2I18n.default.t('Points'),
        [_axis.AXIS_ID_FILTERS]: _d2I18n.default.t('Filter')
      };
