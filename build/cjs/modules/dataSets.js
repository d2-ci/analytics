...
const DATA_SETS_CONSTANTS = [{
  id: REPORTING_RATE,
  getName: () => _d2I18n.default.t('Reporting rate')
}, {
  id: REPORTING_RATE_ON_TIME,
  getName: () => _d2I18n.default.t('Reporting rate on time')
}, {
  id: ACTUAL_REPORTS,
  getName: () => _d2I18n.default.t('Actual reports')
}, {
  id: ACTUAL_REPORTS_ON_TIME,
  getName: () => _d2I18n.default.t('Actual reports on time')
}, {
  id: EXPECTED_REPORTS,
  getName: () => _d2I18n.default.t('Expected reports')
}];
