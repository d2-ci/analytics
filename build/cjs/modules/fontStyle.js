...
const FONT_STYLE_REGRESSION_LINE_LABEL = 'regressionLineLabel';
// Options
...
const FONT_STYLE_OPTION_TEXT_ALIGN = 'textAlign';
// Text align
...
const getFontSizeOptions = fontStyleKey => {
  const fontSizes = [{
    key: 'xSmall',
    label: _d2I18n.default.t('Extra Small'),
    [TIER1]: 11,
    [TIER2]: 9
  }, {
    key: 'small',
    label: _d2I18n.default.t('Small'),
    [TIER1]: 13,
    [TIER2]: 11
  }, {
    key: 'regular',
    label: _d2I18n.default.t('Regular'),
    [TIER1]: 18,
    [TIER2]: 13
  }, {
    key: 'large',
    label: _d2I18n.default.t('Large'),
    [TIER1]: 27,
    [TIER2]: 18
  }, {
    key: 'xLarge',
    label: _d2I18n.default.t('Extra Large'),
    [TIER1]: 42,
    [TIER2]: 24
  }];
...
const defaultAlignOptions = () => [{
  label: _d2I18n.default.t('Left'),
  value: TEXT_ALIGN_LEFT
}, {
  label: _d2I18n.default.t('Center'),
  value: TEXT_ALIGN_CENTER
}, {
  label: _d2I18n.default.t('Right'),
  value: TEXT_ALIGN_RIGHT
}];
const axisTitleAlignOptions = () => [{
  label: _d2I18n.default.t('Start'),
  value: TEXT_ALIGN_LEFT
}, {
  label: _d2I18n.default.t('Middle'),
  value: TEXT_ALIGN_CENTER
}, {
  label: _d2I18n.default.t('End'),
  value: TEXT_ALIGN_RIGHT
}];
const verticalAlignOptions = () => [{
  label: _d2I18n.default.t('Top'),
  value: TEXT_ALIGN_LEFT
}, {
  label: _d2I18n.default.t('Middle'),
  value: TEXT_ALIGN_CENTER
}, {
  label: _d2I18n.default.t('Bottom'),
  value: TEXT_ALIGN_RIGHT
}];
