...
const getModZScoreHelper = (normalizationHelper, config, _ref) => {
  ...
  const [lowThreshold, highThreshold] = medianAD === 0 ? getModZScoreMAD0Thresholds(config[_index.PROP_THRESHOLD_FACTOR], meanAD, median) : getModZScoreThresholds(config[_index.PROP_THRESHOLD_FACTOR], medianAD, median);
  ...
  return {
    ...
    thresholds: [{
      name: _d2I18n.default.t('{{thresholdFactor}} × Modified Z-score low', {
        thresholdFactor: config[_index.PROP_THRESHOLD_FACTOR]
      }),
      value: lowThreshold,
      line: lowThresholdLine
    }, {
      name: _d2I18n.default.t('{{thresholdFactor}} × Modified Z-score high', {
        thresholdFactor: config[_index.PROP_THRESHOLD_FACTOR]
      }),
      value: highThreshold,
