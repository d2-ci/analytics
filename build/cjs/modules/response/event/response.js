...
const includeHeaderChecks = [header => Boolean(header.meta), header => header.name !== _predefinedDimensions.DIMENSION_ID_PERIOD, header => header.name !== _predefinedDimensions.DIMENSION_ID_ORGUNIT && !header.name.endsWith('.ou')];
