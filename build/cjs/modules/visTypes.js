...
const visTypeDisplayNames = {
  [VIS_TYPE_PIVOT_TABLE]: _d2I18n.default.t('Pivot table'),
  [VIS_TYPE_AREA]: _d2I18n.default.t('Area'),
  [VIS_TYPE_STACKED_AREA]: _d2I18n.default.t('Stacked area'),
  [VIS_TYPE_BAR]: _d2I18n.default.t('Bar'),
  [VIS_TYPE_STACKED_BAR]: _d2I18n.default.t('Stacked bar'),
  [VIS_TYPE_COLUMN]: _d2I18n.default.t('Column'),
  [VIS_TYPE_YEAR_OVER_YEAR_COLUMN]: _d2I18n.default.t('Year over year (column)'),
  [VIS_TYPE_STACKED_COLUMN]: _d2I18n.default.t('Stacked column'),
  [VIS_TYPE_GAUGE]: _d2I18n.default.t('Gauge'),
  [VIS_TYPE_LINE]: _d2I18n.default.t('Line'),
  [VIS_TYPE_LINE_LIST]: _d2I18n.default.t('Line list'),
  [VIS_TYPE_YEAR_OVER_YEAR_LINE]: _d2I18n.default.t('Year over year (line)'),
  [VIS_TYPE_PIE]: _d2I18n.default.t('Pie'),
  [VIS_TYPE_RADAR]: _d2I18n.default.t('Radar'),
  [VIS_TYPE_SCATTER]: _d2I18n.default.t('Scatter'),
  [VIS_TYPE_SINGLE_VALUE]: _d2I18n.default.t('Single value'),
  [VIS_TYPE_OUTLIER_TABLE]: _d2I18n.default.t('Outlier table'),
  [VIS_TYPE_GROUP_ALL]: _d2I18n.default.t('All types'),
  [VIS_TYPE_GROUP_CHARTS]: _d2I18n.default.t('All charts')
};
