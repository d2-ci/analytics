...
var _donut = _interopRequireDefault(require("./donut.js"));
...
function getDefault(_ref) {
  ...
  series.forEach((seriesObj, index) => {
    ...
    // axis number
    seriesObj.yAxis = (0, _visTypes.isDualAxisType)(layout.type) && !(0, _axisHasRelativeItems.axisHasRelativeItems)(layout.columns) ? (0, _axisId.getAxisStringFromId)(fullIdAxisMap[seriesObj.id]) : (0, _axisId.getAxisStringFromId)(0);
...
function _default(_ref2) {
  ...
  switch (layout.type) {
    ...
    case _visTypes.VIS_TYPE_PIE:
      ...
      break;
    case _visTypes.VIS_TYPE_DONUT:
      series = (0, _donut.default)(series, Object.values(getIdColorMap(series, layout, extraOptions)));
      break;
