  ...
  layoutAxes.forEach(axis => {
    ...
    if (useMultiAxisMode) {
      ...
      regressionLines.forEach(rl => {
        ...
        if ((_rl$title = rl.title) !== null && _rl$title !== void 0 && _rl$title.text) {
          ...
          rl.title = {
            ...rl.title,
            text: `${rl.title.text} - ${((_axis$title = axis.title) === null || _axis$title === void 0 ? void 0 : _axis$title.text) || _d2I18n.default.t('Axis {{axisId}}', {
              axisId: axis.index + 1
            })}`
          };
        }
    ...
    if (((_axis$title3 = axis.title) === null || _axis$title3 === void 0 ? void 0 : _axis$title3.textMode) === 'AUTO') {
      if (layout.type === _visTypes.VIS_TYPE_SCATTER || series.length === 1) {
        ...
        titleText = _d2I18n.default.t('Axis {{axisId}}', {
          axisId: axis.index + 1
        });
      } else if (series.length > 1) {
        titleText = _d2I18n.default.t('{{count}} items', {
          count: series.length,
