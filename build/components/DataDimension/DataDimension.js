...
var DataDimension = /*#__PURE__*/function (_Component) {
  (0, _inherits2.default)(DataDimension, _Component);

  var _super = _createSuper(DataDimension);
  ...
  function DataDimension() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "updateGroups", /*#__PURE__*/(0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "updateAlternatives", /*#__PURE__*/(0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2() {
      var page,
          concatItems,
          _this$state,
          dataType,
      ...
      return _regenerator.default.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 8:
              alternatives = _context2.t0;
              dimensionItems = alternatives.dimensionItems;
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onGroupChange", /*#__PURE__*/function () {
      var _ref3 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee3(groupId) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onClearFilter", function () {
      _this.setState({
        filterText: ''
      }, (0, _debounce.default)( /*#__PURE__*/(0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee4() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onFilterTextChange", function (filterText) {
      _this.setState({
        filterText: filterText
      }, (0, _debounce.default)( /*#__PURE__*/(0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee5() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "selectItems", function (selectedIds) {
      ...
      _this.props.onSelect({
        ...
        items: [].concat((0, _toConsumableArray2.default)(_this.props.selectedDimensions.filter(function (item) {
          return !selectedIds.includes(item.id);
        })), (0, _toConsumableArray2.default)(itemsToAdd))
      });
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "deselectItems", function (itemIdsToRemove) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "render", function () {
      ...
      var filterZone = function filterZone() {
        return /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_DataTypesSelector.default, {
        ...
        }), /*#__PURE__*/_react.default.createElement(_FilterField.default, {
      ...
      var selected = {
        ...
        infoBoxMessage: _this.props.infoBoxMessage,
        dialogId: _predefinedDimensions.DIMENSION_ID_DATA,
        onDeselect: _this.deselectItems,
        onReorder: _this.reorderItems
      };
      return /*#__PURE__*/_react.default.createElement(_react.Fragment, null, /*#__PURE__*/_react.default.createElement(_DialogTitle.default, null, _d2I18n.default.t('Data')), /*#__PURE__*/_react.default.createElement(_DialogContent.default, {
