  ...
  function DataDimension() {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 8:
              ...
              augmentedDimensionItems = augmentFn ? augmentFn(dimensionItems, groupId) : dimensionItems;
              items = concatItems ? _this.state.items.concat(augmentedDimensionItems) : augmentedDimensionItems;
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "selectItems", function (selectedIds) {
      ...
      _this.props.onSelect({
        dimensionId: _fixedDimensions.DIMENSION_ID_DATA,
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "render", function () {
      ...
      var selected = {
        ...
        dialogId: _fixedDimensions.DIMENSION_ID_DATA,
