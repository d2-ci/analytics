...
describe('The Filter component ', function () {
  ...
  var filterComp = function filterComp() {
    if (!shallowFilter) {
      shallowFilter = (0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(_Filter.Filter, props));
    }
  ...
  it('renders a TextField component containing everything else', function () {
