...
const DefaultUnit = props => /*#__PURE__*/React.createElement(InterpretationsUnit, _extends({
  id: "abcd",
...
export const Default = () => /*#__PURE__*/React.createElement(InterpretationsStory, null, /*#__PURE__*/React.createElement(DefaultUnit, null));
export const WithNoTimeDimensionsWarning = () => /*#__PURE__*/React.createElement(InterpretationsStory, null, /*#__PURE__*/React.createElement(DefaultUnit, {
  visualizationHasTimeDimension: false
}));
WithNoTimeDimensionsWarning.story = {
  name: 'With no time dimensions warning'
};
export const Loading = () => /*#__PURE__*/React.createElement(InterpretationsStory, {
...
export const DashboardUsage = () => /*#__PURE__*/React.createElement(InterpretationsStory, {
...
}, /*#__PURE__*/React.createElement(DefaultUnit, {
  dashboardRedirectUrl: dashboardRedirectUrl
}));
DashboardUsage.story = {
  name: 'Dashboard usage'
};
export const WithOneInterpretation = () => /*#__PURE__*/React.createElement(InterpretationsStory, {
  interpretations: [makeInterpretation({
    id: 'interp-1',
    text: 'The ANC coverage rate has improved steadily across all districts this quarter, with the Eastern region showing the most significant gains. This aligns with the increased outreach activities reported in the monthly summaries.',
    created: '2026-04-10T14:22:00.000',
...
export const WithInterpretationForCurrentUser = () => /*#__PURE__*/React.createElement(InterpretationsStory, {
  interpretations: [makeInterpretation({
    id: 'interp-short',
...
export const StressTest = () => /*#__PURE__*/React.createElement(InterpretationsStory, {
  containerWidth: 360,
  interpretations: [makeInterpretation({
    id: 'interp-verbose-a',
...
export const WithManyInterpretations = () => /*#__PURE__*/React.createElement(InterpretationsStory, {
  interpretations: [makeInterpretation({
    id: 'interp-m01',
