...
storiesOf('PivotTable', module).addDecorator(PivotTableOptionsWrapper).add('simple', (_, _ref3) => {
  ...
  const visualization = { ...simpleVisualization,
    ...visualizationReset,
    ...pivotTableOptions
  };
...
storiesOf('PivotTable', module).add('simple - avg totalAggregationType columns', (_, _ref14) => {
  ...
  const visualization = { ...avgVisualization,
    ...visualizationReset,
    ...pivotTableOptions,
    colTotals: true,
    hideEmptyRows: true
...
storiesOf('PivotTable', module).add('deep', (_, _ref16) => {
  ...
  const visualization = { ...deepVisualization,
    ...visualizationReset,
    ...pivotTableOptions,
...
storiesOf('PivotTable', module).add('deep - filter', (_, _ref17) => {
  ...
  const visualization = { ...deepWithFiltersVisualization,
    ...visualizationReset,
    ...pivotTableOptions,
    showDimensionLabels: false
  };
...
storiesOf('PivotTable', module).add('small empty rows - shown', (_, _ref29) => {
  ...
  const visualization = { ...diseaseWeeksVisualization,
    ...visualizationReset,
    ...pivotTableOptions,
    colTotals: true,
    rowTotals: true,
...
storiesOf('PivotTable', module).add('empty rows - shown', (_, _ref31) => {
  ...
  const visualization = { ...emptyRowsVisualization,
    ...visualizationReset,
    ...pivotTableOptions,
    rowSubTotals: true,
    colSubTotals: true,
...
storiesOf('PivotTable', module).add('empty columns - shown', (_, _ref33) => {
  ...
  const visualization = { ...lastFiveYearsVisualization,
    ...pivotTableOptions,
    hideEmptyColumns: false
  };
  return /*#__PURE__*/React.createElement("div", {
...
storiesOf('PivotTable', module).add('empty columns (weekly) - shown', (_, _ref35) => {
  ...
  const visualization = { ...weeklyColumnsVisualization,
    ...pivotTableOptions,
    hideEmptyColumns: false
  };
  return /*#__PURE__*/React.createElement("div", {
...
storiesOf('PivotTable', module).add('empty columns + assigned cats (shown)', (_, _ref37) => {
  ...
  const visualization = { ...emptyColumnsVisualization,
    ...visualizationReset,
    ...pivotTableOptions,
    hideEmptyColumns: false
  };
...
storiesOf('PivotTable', module).add('legend - fixed (light fill)', (_, _ref39) => {
  ...
  const visualization = { ...targetVisualization,
    ...visualizationReset,
    ...pivotTableOptions,
    rowSubTotals: true,
    colSubTotals: true,
...
storiesOf('PivotTable', module).add('hierarchy - none', (_, _ref44) => {
  ...
  const visualization = { ...hierarchyVisualization,
    ...visualizationReset,
    ...pivotTableOptions,
    showHierarchy: false,
    colTotals: true,
...
storiesOf('PivotTable', module).add('DEGS', (_, _ref49) => {
  ...
  const visualization = { ...degsVisualization,
    ...visualizationReset,
    ...pivotTableOptions
  };
  return /*#__PURE__*/React.createElement("div", {
