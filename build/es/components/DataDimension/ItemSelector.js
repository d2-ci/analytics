...
import OptionSetModal from './OptionSet/OptionSetModal.js';
...
const ItemSelector = _ref5 => {
  ...
  const onEditClick = dataItem => {
    ...
    if (dataItemType === DIMENSION_TYPE_EXPRESSION_DIMENSION_ITEM && !(((_dataItem$access = dataItem.access) === null || _dataItem$access === void 0 ? void 0 : _dataItem$access.write) === false) && state.supportsEDI) {
      // calculation
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    displayNameProp: displayNameProp
  }), (currentOptionSet === null || currentOptionSet === void 0 ? void 0 : currentOptionSet.id) && /*#__PURE__*/React.createElement(OptionSetModal, _extends({}, currentOptionSet, {
    displayNameProp: displayNameProp,
...
ItemSelector.propTypes = {
  ...
  onOptionSetSave: PropTypes.func
};
