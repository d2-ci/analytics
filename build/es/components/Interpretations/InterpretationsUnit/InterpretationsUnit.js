...
export const InterpretationsUnit = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: _JSXStyle.dynamic([["515377163", [spacers.dp16, colors.white, spacers.dp24, spacers.dp12, colors.grey900]]]) + " " + (cx('container', {
      expanded: isExpanded
    }) || "")
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => setIsExpanded(!isExpanded),
    className: _JSXStyle.dynamic([["515377163", [spacers.dp16, colors.white, spacers.dp24, spacers.dp12, colors.grey900]]]) + " " + "header"
  }, /*#__PURE__*/React.createElement("span", {
    className: _JSXStyle.dynamic([["515377163", [spacers.dp16, colors.white, spacers.dp24, spacers.dp12, colors.grey900]]]) + " " + "title"
    ...
    className: _JSXStyle.dynamic([["515377163", [spacers.dp16, colors.white, spacers.dp24, spacers.dp12, colors.grey900]]]) + " " + "loader"
    ...
    id: "515377163",
    dynamic: [spacers.dp16, colors.white, spacers.dp24, spacers.dp12, colors.grey900]
  }, [`.container.__jsx-style-dynamic-selector{position:relative;padding:${spacers.dp16};background-color:${colors.white};}`, `.expanded.__jsx-style-dynamic-selector{padding-block-end:${spacers.dp24};}`, ".loader.__jsx-style-dynamic-selector{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-box-pack:center;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;}", `.header.__jsx-style-dynamic-selector{all:unset;inline-size:100%;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-box-pack:justify;-webkit-justify-content:space-between;-ms-flex-pack:justify;justify-content:space-between;cursor:pointer;margin-block-end:${spacers.dp12};}`, `.title.__jsx-style-dynamic-selector{font-size:16px;font-weight:500;line-height:21px;color:${colors.grey900};}`]));
};
