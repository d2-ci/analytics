...
const renderTable = props => render(/*#__PURE__*/React.createElement(PivotTable, _extends({
  visualization: visualization,
  data: deepWithFiltersData
}, props)));
const titleRowTexts = () => screen.queryAllByTestId('visualization-title').map(element => element.textContent);
