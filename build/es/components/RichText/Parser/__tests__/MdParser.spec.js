...
describe('MdParser class', () => {
  it('converts text into HTML', () => {
    ...
    ['example.com/path_with_underscore', '<a href="http://example.com/path_with_underscore" target="_blank" rel="noopener">example.com/path_with_underscore</a>'], ['_italic_ and *bold* with a example.com/link_with_underscore', '<em>italic</em> and <strong>bold</strong> with a <a href="http://example.com/link_with_underscore" target="_blank" rel="noopener">example.com/link_with_underscore</a>'], ['example.com/path with *bold* after :)', '<a href="http://example.com/path" target="_blank" rel="noopener">example.com/path</a> with <strong>bold</strong> after <span>\u{1F642}</span>'], ['_before_ example.com/path_with_underscore *after* :)', '<em>before</em> <a href="http://example.com/path_with_underscore" target="_blank" rel="noopener">example.com/path_with_underscore</a> <strong>after</strong> <span>\u{1F642}</span>'],
