...
import React, { Component, Fragment, useRef, useState, useEffect, useCallback, useMemo, createContext, useContext } from 'react';
import PropTypes from 'prop-types';
import debounce from 'lodash/debounce';
import isEqual from 'lodash/isEqual';
import _JSXStyle from 'styled-jsx/style';
import cx from 'classnames';
import { colors, theme, Button, SingleSelectField, SingleSelectOption, InputField, spacers, TabBar, Tab, Transfer, CircularLoader } from '@dhis2/ui-core';
...
import { userOrgUnits, OrgUnitSelector } from '@dhis2/d2-ui-org-unit-dialog';
...
import isObject$1 from 'd2-utilizr/lib/isObject';
import isString$1 from 'd2-utilizr/lib/isString';
...
const _defaultExport = [".highlighted-text.jsx-8772423{color:".concat(colors.white, ";}"), ".item.jsx-8772423{-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;border-radius:4px;cursor:pointer;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;padding:3px;}", ".unselected-item.jsx-8772423:hover{background-color:#e0e0e0;}", ".highlighted-item.jsx-8772423{background-color:".concat(theme.secondary800, ";}"), ".item-label.jsx-8772423{font-size:14px;padding:2px 5px 2px 2px;}"];
...
}, iconType === 'arrowForward' ? /*#__PURE__*/React.createElement(ArrowForward, null) : /*#__PURE__*/React.createElement(ArrowBack, null)), /*#__PURE__*/React.createElement(_JSXStyle, {
...
class UnselectedItems extends Component {
  constructor(props) {
    super(props);
    ...
    _defineProperty(this, "renderListItem", (dataDim, index) => /*#__PURE__*/React.createElement("li", {
      key: dataDim.id,
    ...
    _defineProperty(this, "render", () => {
      ...
      }, i18n.t('Select all'))), /*#__PURE__*/React.createElement("div", {
...
const DeselectIconButton = ({
  ...
  }, /*#__PURE__*/React.createElement(DeselectIcon, {
    style: iconStyle
  })), /*#__PURE__*/React.createElement(_JSXStyle, {
...
const _defaultExport$4 = [".highlighted-text.jsx-2633005402{color:".concat(colors.white, ";}"), ".icon.jsx-2633005402{background-color:".concat(theme.secondary600, ";}"), ".item.jsx-2633005402{-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;border-radius:4px;cursor:pointer;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;padding:3px;}", ".ghost.jsx-2633005402{opacity:0.2;-webkit-transition:opacity 0.2s ease;transition:opacity 0.2s ease;}", ".selected-item.jsx-2633005402{background-color:".concat(theme.secondary200, ";}"), ".selected-item.jsx-2633005402:hover{background-color:#86c4bf;}", ".highlighted-item.jsx-2633005402{background-color:".concat(theme.secondary800, ";}"), ".inactive-item.jsx-2633005402{opacity:0.3;}", ".item-label.jsx-2633005402{font-size:14px;padding:2px;}"];
...
const Item$1 = (_ref) => {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    backgroundColor: highlighted ? colors.white : theme.secondary600
  }), /*#__PURE__*/React.createElement("span", {
    className: "jsx-".concat(_defaultExport$4.__hash) + " " + (cx('item-label', {
      'highlighted-text': highlighted
    }) || "")
  }, name), /*#__PURE__*/React.createElement(DeselectIconButton, {
...
}, i18n.t('Selected Data')), /*#__PURE__*/React.createElement(_JSXStyle, {
...
class SelectedItems extends Component {
  constructor(...args) {
    ...
    _defineProperty(this, "renderListItem", ({
      ...
      name,
      isActive
    }, index) => /*#__PURE__*/React.createElement(Draggable, {
      draggableId: id,
      index: index,
      key: id
    }, (provided, snapshot) => {
    ...
    _defineProperty(this, "render", () => {
      ...
      return /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement(Subtitle, null), this.props.infoBoxMessage ? /*#__PURE__*/React.createElement(InfoBox, {
        message: this.props.infoBoxMessage
      }) : null, /*#__PURE__*/React.createElement(DragDropContext, {
        onDragStart: this.onDragStart,
        onDragEnd: this.onDragEnd
      }, /*#__PURE__*/React.createElement(Droppable, {
        droppableId: "selected-items-droppable"
      }, provided => /*#__PURE__*/React.createElement(ItemsList, _extends({
        innerRef: provided.innerRef
      }, provided.droppableProps), itemList, provided.placeholder))), /*#__PURE__*/React.createElement("div", {
        className: "jsx-".concat(_defaultExport$5.__hash) + " " + "deselect-all-button"
      }, /*#__PURE__*/React.createElement(Button, {
        onClick: this.onDeselectAll
      }, i18n.t('Deselect All'))), /*#__PURE__*/React.createElement("div", {
...
const _defaultExport$6 = [".item-selector-container.jsx-1669762466{box-sizing:border-box;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-flex:1 1 auto;-ms-flex:1 1 auto;flex:1 1 auto;font-family:Roboto,sans-serif;}", ".section.jsx-1669762466{border:1px solid ".concat(colors.grey300, ";display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-flex-direction:column;-ms-flex-direction:column;flex-direction:column;height:480px;position:relative;}"), ".unselected.jsx-1669762466{margin-right:55px;width:418px;}", ".selected.jsx-1669762466{width:276px;}"];
...
class ItemSelector extends Component {
  render() {
    ...
    }, filterZone, /*#__PURE__*/React.createElement(UnselectedItems, unselected)), /*#__PURE__*/React.createElement("div", {
      className: "jsx-".concat(_defaultExport$6.__hash) + " " + (cx('section', 'selected') || "")
    }, /*#__PURE__*/React.createElement(SelectedItems, selected)), /*#__PURE__*/React.createElement(_JSXStyle, {
...
const _defaultExport$9 = [".container.jsx-2662255650{border:1px solid ".concat(colors.grey300, ";display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;min-height:53px;border-right:0;border-left:0;padding-top:5px;padding-left:10px;}"), ".group-container.jsx-2662255650{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-flex-direction:column;-ms-flex-direction:column;flex-direction:column;width:inherit;min-width:294px;-webkit-box-flex:1;-webkit-flex-grow:1;-ms-flex-positive:1;flex-grow:1;padding-right:5px;}"];
...
const Groups = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, _defaultExport$9), /*#__PURE__*/React.createElement("div", {
    ...
    dense: true
  }, optionItems.map(item => /*#__PURE__*/React.createElement(SingleSelectOption, {
    value: item.id,
    key: item.id,
    label: item.name
  })))), groupDetail && /*#__PURE__*/React.createElement(Detail$o, {
...
const _defaultExport$a = [".container.jsx-152958988{border:1px solid ".concat(colors.grey300, ";background-color:").concat(colors.white, ";height:53px;border-right:0;border-left:0;border-top:0;padding:10px 5px 10px 10px;}")];
...
}, /*#__PURE__*/React.createElement(Filter$o, {
...
class DataDimension extends Component {
  constructor(...args) {
    super(...args);
    ...
    _defineProperty(this, "render", () => {
      ...
      const filterZone = () => {
        return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(DataTypes, {
...
const _defaultExport$b = [".leftSection.jsx-2872988609{-webkit-box-flex:1;-webkit-flex-grow:1;-ms-flex-positive:1;flex-grow:1;}", ".leftSection.jsx-2872988609>.filterElement,.rightSection.jsx-2872988609>.filterElement{margin:0;}", ".rightSection.jsx-2872988609{width:120px;margin-left:".concat(spacers.dp8, ";}")];
...
}, getFixedPeriodsOptions().map(option => /*#__PURE__*/React.createElement(SingleSelectOption, {
  key: option.id,
  value: option.id,
...
const RelativePeriodFilter = ({
  ...
  className: "filterElement"
}, getRelativePeriodsOptions().map(option => /*#__PURE__*/React.createElement(SingleSelectOption, {
  key: option.id,
  value: option.id,
  label: option.getName()
}))), /*#__PURE__*/React.createElement(_JSXStyle, {
...
const _defaultExport$c = [".filterContainer.jsx-901925928{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;margin-bottom:".concat(spacers.dp12, ";margin-top:").concat(spacers.dp8, ";}"), ".emptySelection.jsx-901925928{text-align:center;font-size:14px;line-height:16px;margin:".concat(spacers.dp24, " 0 0;color:").concat(colors.grey700, ";}")];
_defaultExport$c.__hash = "901925928";

const _defaultExport$d = [".wrapper.jsx-911965247:last-child{margin-bottom:".concat(spacers.dp4, ";}"), ".chip.jsx-911965247{display:inline-block;background:".concat(colors.grey200, ";font-size:14px;line-height:16px;padding:2px ").concat(spacers.dp8, " 2px ").concat(spacers.dp4, ";margin-top:").concat(spacers.dp4, ";margin-left:").concat(spacers.dp8, ";border-radius:3px;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;}"), ".chip.jsx-911965247:hover{background:".concat(colors.grey300, ";}"), ".chip.highlighted.jsx-911965247{background:".concat(theme.secondary800, ";color:").concat(colors.white, ";}"), ".chip.highlighted.jsx-911965247 .icon path{fill:".concat(colors.white, ";}"), ".chip.disabled.jsx-911965247{opacity:0.3;cursor:not-allowed;}", ".icon.jsx-911965247,.label.jsx-911965247{line-height:18px;}", ".icon.jsx-911965247{margin-right:".concat(spacers.dp4, ";display:-webkit-inline-box;display:-webkit-inline-flex;display:-ms-inline-flexbox;display:inline-flex;vertical-align:text-bottom;}"), ".label.jsx-911965247{font-size:14px;}"];
...
var PeriodIcon$1 = /*#__PURE__*/React.createElement("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  width: "16",
  height: "16",
  viewBox: "0 0 16 16"
...
class PeriodSelector extends Component {
  constructor(props) {
    ...
    _defineProperty(this, "renderHeader", () => /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(TabBar, null, /*#__PURE__*/React.createElement(Tab, {
    ...
    }, this.state.isRelative ? /*#__PURE__*/React.createElement(RelativePeriodFilter, {
    ...
    _defineProperty(this, "renderEmptySelection", () => /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("p", {
    ...
    _defineProperty(this, "render", () => /*#__PURE__*/React.createElement(Transfer, {
      onChange: ({
        selected
      }) => {
        this.setState({
    ...
    }, this.state.allPeriods.map(item => /*#__PURE__*/React.createElement(TransferOption, {
      label: item.getName(),
      value: item.id,
      key: item.id,
      icon: PeriodIcon$1
...
const PeriodDimension = ({
  ...
  return /*#__PURE__*/React.createElement(PeriodSelector, {
...
var GenericIcon = /*#__PURE__*/React.createElement("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  width: "16",
  height: "16",
  viewBox: "0 0 16 16"
...
const ItemSelector$1 = ({
  ...
  const [selectedItems, setSelectedItems] = useState(initialSelectedItems.map(item => ({
    label: item.name,
    value: item.id,
    key: item.id
  })));
  ...
  }, allItems.map(item => /*#__PURE__*/React.createElement(TransferOption, {
    label: item.name,
    value: item.id,
    key: item.id,
    icon: GenericIcon
...
const DynamicDimension = ({
  ...
  return /*#__PURE__*/React.createElement(ItemSelector$1, {
...
class RecommendedIcon extends Component {
  constructor(...args) {
    super(...args);
    ...
    _defineProperty(this, "showTooltip", () => /*#__PURE__*/React.createElement(Popper, {
  ...
  render() {
    ...
    return this.props.isRecommended ? /*#__PURE__*/React.createElement("div", {
...
const OptionsButton = ({
  ...
  style: style,
  onClick: onClick
}, /*#__PURE__*/React.createElement(MoreHorizontalIcon, null));
...
class DimensionItem extends Component {
  ...
  render() {
    ...
    }, rest), /*#__PURE__*/React.createElement(DimensionLabel, {
      id: id,
...
var DimensionList$1 = withStyles(styles$3)(DimensionList);
...
class DimensionsPanel extends Component {
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      type: "search"
    }), /*#__PURE__*/React.createElement(DimensionList$1, {
...
var BarIcon = /*#__PURE__*/React.createElement(SvgIcon, {
  viewBox: "0 0 16 16"
}, /*#__PURE__*/React.createElement("g", {
  stroke: "none",
  strokeWidth: "1",
...
var StackedBarIcon = /*#__PURE__*/React.createElement(SvgIcon, {
  viewBox: "0 0 16 16"
}, /*#__PURE__*/React.createElement("g", {
  stroke: "none",
  strokeWidth: "1",
...
var ColumnIcon = /*#__PURE__*/React.createElement(SvgIcon, {
  viewBox: "0 0 16 16"
}, /*#__PURE__*/React.createElement("g", {
  stroke: "none",
  strokeWidth: "1",
...
var StackedColumnIcon = /*#__PURE__*/React.createElement(SvgIcon, {
  viewBox: "0 0 16 16"
}, /*#__PURE__*/React.createElement("g", {
  stroke: "none",
  strokeWidth: "1",
...
var LineIcon = /*#__PURE__*/React.createElement(SvgIcon, {
  viewBox: "0 0 16 16"
}, /*#__PURE__*/React.createElement("g", {
  stroke: "none",
  strokeWidth: "1",
...
var AreaIcon = /*#__PURE__*/React.createElement(SvgIcon, {
  viewBox: "0 0 16 16"
}, /*#__PURE__*/React.createElement("g", {
  stroke: "none",
  strokeWidth: "1",
...
var PieIcon = /*#__PURE__*/React.createElement(SvgIcon, {
  viewBox: "0 0 16 16"
}, /*#__PURE__*/React.createElement("g", {
  stroke: "none",
  strokeWidth: "1",
...
var RadarIcon = /*#__PURE__*/React.createElement(SvgIcon, {
  viewBox: "0 0 16 16"
}, /*#__PURE__*/React.createElement("g", {
  stroke: "none",
  strokeWidth: "1",
...
var GaugeIcon = /*#__PURE__*/React.createElement(SvgIcon, {
  viewBox: "0 0 16 16"
}, /*#__PURE__*/React.createElement("g", {
  stroke: "none",
  strokeWidth: "1",
...
var YearOverYearLineIcon = /*#__PURE__*/React.createElement(SvgIcon, {
  viewBox: "0 0 16 16"
}, /*#__PURE__*/React.createElement("g", {
  stroke: "none",
  strokeWidth: "1",
...
var YearOverYearColumnIcon = /*#__PURE__*/React.createElement(SvgIcon, {
  viewBox: "0 0 16 16"
}, /*#__PURE__*/React.createElement("g", {
  stroke: "none",
  strokeWidth: "1",
...
var SingleValueIcon = /*#__PURE__*/React.createElement(SvgIcon, {
  viewBox: "0 0 16 16"
}, /*#__PURE__*/React.createElement("g", {
  stroke: "none",
  strokeWidth: "1",
...
var PivotTableIcon = /*#__PURE__*/React.createElement(SvgIcon, {
  viewBox: "0 0 16 16"
}, /*#__PURE__*/React.createElement("g", {
  stroke: "none",
  strokeWidth: "1",
...
const getDividerItem = key => /*#__PURE__*/React.createElement(Divider, {
  light: true,
  key: key
});
...
class DimensionMenu extends Component {
  ...
  render() {
    ...
    const getDualAxisMenuItem = isDisabled => /*#__PURE__*/React.createElement(MenuItem, {
      ...
      disabled: isDisabled
    }, /*#__PURE__*/React.createElement("div", null, i18n.t('Manage chart axes'))); // Create dual axis menu item
    ...
    if (dimensionId === DIMENSION_ID_DATA) {
      if (currentAxisId === AXIS_ID_COLUMNS && isDualAxisType(visType) && numberOfDimensionItems >= 2) {
        ...
        menuItems.push( /*#__PURE__*/React.createElement(Tooltip, {
          ...
          classes: classes
        }, /*#__PURE__*/React.createElement("div", null, getDualAxisMenuItem(true))));
      } // divider
    ...
    if (dimensionId === DIMENSION_ID_DATA && assignedCategoriesItemHandler) {
      if (assignedCategoriesAvailableDestinations.length) {
        if (!isAssignedCategoriesInLayout) {
          ...
          }, /*#__PURE__*/React.createElement("div", null, assignedCategoriesItemLabel), /*#__PURE__*/React.createElement(ArrowRightIcon, null)));
          menuItems.push( /*#__PURE__*/React.createElement(Menu, {
          ...
          }, /*#__PURE__*/React.createElement("div", null, assignedCategoriesItemLabel)));
        }
      } else {
        menuItems.push( /*#__PURE__*/React.createElement(Tooltip, {
          key: "assigned-categories-item-".concat(dimensionId),
...
const PivotTableEngineContext = createContext(null);
const Provider = ({
  engine,
  children
}) => {
...
const table = ["div.pivot-table-container.jsx-3458923541{font-family:'Roboto',Arial,sans-serif;overflow:auto;color:".concat(colors.grey900, ";}"), "table.jsx-3458923541{border-spacing:0;border-collapse:collapse;white-space:nowrap;overflow:hidden;box-sizing:border-box;text-align:center;}"];
...
const PivotTableContainer = React.forwardRef(({
  width,
  height,
  children
  ...
  id: table.__hash
}, table), width === 0 || height === 0 ? null : /*#__PURE__*/React.createElement("table", {
...
const PivotTableClippedAxis = ({
  ...
  EmptyComponent,
  ItemComponent
}) => [axisClippingResult.pre ? /*#__PURE__*/React.createElement(EmptyComponent, {
  key: "pre",
...
const PivotTableCell = React.forwardRef((_ref, ref) => {
  let {
    classes,
    isColumnHeader,
    children,
  ...
  return isColumnHeader ? /*#__PURE__*/React.createElement("th", _extends({
    style: style
  }, props, {
    className: "jsx-".concat(cell.__hash) + " " + (props && props.className != null && props.className || className || "")
  }), /*#__PURE__*/React.createElement(_JSXStyle, {
    id: cell.__hash
  }, cell), children) : /*#__PURE__*/React.createElement("td", _extends({
    ref: ref,
    style: style
  }, props, {
    className: "jsx-".concat(cell.__hash) + " " + (props && props.className != null && props.className || className || "")
...
const SortIconAscending = () => /*#__PURE__*/React.createElement("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 6 10",
  height: "100%"
}, /*#__PURE__*/React.createElement("g", {
...
const SortIconDescending = () => /*#__PURE__*/React.createElement("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 6 10",
  height: "100%"
}, /*#__PURE__*/React.createElement("g", {
...
const SortIconIdle = () => /*#__PURE__*/React.createElement("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 6 10",
  height: "100%"
}, /*#__PURE__*/React.createElement("g", {
...
const PivotTableSortIcon = ({
  ...
  return /*#__PURE__*/React.createElement("span", {
    ...
    id: sortIcon.__hash
  }, sortIcon), /*#__PURE__*/React.createElement(SortIcon, {
...
const PivotTableEmptyCell = React.forwardRef((_ref, ref) => {
...
const PivotTableTitleRow = ({
  ...
  return /*#__PURE__*/React.createElement("tr", {
    ...
    id: cell.__hash
  }, cell), /*#__PURE__*/React.createElement(PivotTableCell, {
...
const PivotTableTitleRows = ({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, engine.options.title ? /*#__PURE__*/React.createElement(PivotTableTitleRow, {
    ...
    containerWidth: width,
    totalWidth: engine.dataPixelWidth + engine.rowHeaderPixelWidth
  }) : null, ((_engine$visualization = engine.visualization.filters) === null || _engine$visualization === void 0 ? void 0 : _engine$visualization.length) ? /*#__PURE__*/React.createElement(PivotTableTitleRow, {
...
const PivotTableHead = ({
  ...
  sortBy,
  onSortByColumn
}) => /*#__PURE__*/React.createElement("thead", null, /*#__PURE__*/React.createElement(PivotTableTitleRows, {
  clippingResult: clippingResult,
  width: width
...
const PivotTableRow = ({
  ...
  return /*#__PURE__*/React.createElement("tr", null, times(engine.rowDepth, x => x).map(rowLevel => /*#__PURE__*/React.createElement(PivotTableRowHeaderCell, {
    ...
    axisClippingResult: clippingResult.columns,
    EmptyComponent: () => /*#__PURE__*/React.createElement(PivotTableEmptyCell, {
      classes: "value"
    }),
    ItemComponent: ({
      index: columnIndex
...
export { AXIS, AXIS_ID_COLUMNS, AXIS_ID_FILTERS, AXIS_ID_ROWS, DEFAULT_AXIS_IDS, DIMENSION, DIMENSION_ID_ASSIGNED_CATEGORIES, DIMENSION_ID_DATA, DIMENSION_ID_ORGUNIT, DIMENSION_ID_PERIOD, DIMENSION_PROPS, DIMENSION_PROP_ID, DIMENSION_PROP_ITEMS, DIMENSION_PROP_NO_ITEMS, DataDimension, Filter$o as DimensionFilter, DimensionItem, DimensionMenu, DimensionsPanel, DynamicDimension, ITEM, ITEM_PROPS, ITEM_PROP_ID, ItemSelector, LAYOUT, LAYOUT_TYPE_DEFAULT, LAYOUT_TYPE_PIE, LAYOUT_TYPE_PIVOT_TABLE, LAYOUT_TYPE_SINGLE_VALUE, LAYOUT_TYPE_YEAR_OVER_YEAR, OrgUnitDimension, PeriodDimension, PivotTable, VIS_TYPE_AREA, VIS_TYPE_BAR, VIS_TYPE_BUBBLE, VIS_TYPE_COLUMN, VIS_TYPE_GAUGE, VIS_TYPE_LINE, VIS_TYPE_PIE, VIS_TYPE_PIVOT_TABLE, VIS_TYPE_RADAR, VIS_TYPE_SINGLE_VALUE, VIS_TYPE_STACKED_BAR, VIS_TYPE_STACKED_COLUMN, VIS_TYPE_YEAR_OVER_YEAR_COLUMN, VIS_TYPE_YEAR_OVER_YEAR_LINE, apiFetchDimensions, apiFetchRecommendedIds, axisGetAllItems, axisGetDimension, axisGetDimensionIds, axisHasDataDimension, axisHasDimension, axisHasOuDimension, axisHasPeriodDimension, axisIsEmpty, canDimensionBeAddedToAxisByVisType as canDimensionBeAddedToAxis, createVisualization, defaultVisType, dimensionCreate, dimensionGetId, dimensionGetItemIds, dimensionGetItems, dimensionIs, dimensionIsEmpty, dimensionIsValid, filterOutPredefinedDimensions, getAllLockedDimIdsByVisType as getAllLockedDimensionIds, getAvailableAxesByVisType as getAvailableAxes, getAxisMaxNumberOfDimsByVisType as getAxisMaxNumberOfDimensions, getAxisMaxNumberOfItemsByVisType as getAxisMaxNumberOfItems, getAxisMinNumberOfDimsByVisType as getAxisMinNumberOfDimensions, getAxisName, getAxisNameByLayoutType, getAxisPerLockedDimByVisType as getAxisPerLockedDimension, getDimensionById, getDisallowedDimsByVisType as getDisallowedDimensions, getDisplayNameByVisType, getDynamicDimensions, getFixedDimensions, getLayoutTypeByVisType, getPredefinedDimensionProp, getPredefinedDimensions, getTransferableDimensionPerAxisByVisType as getTransferableDimension, hasAxisTooManyItemsByVisType as hasAxisTooManyItems, isAxisFullByVisType as isAxisFull, isDimensionLockedByVisType as isDimensionLocked, isDualAxisType, isSingleValue, isStacked, isYearOverYear, itemGetId, itemIsValid, layoutFilterDimensions, layoutGetAllAxes, layoutGetAllDimensions, layoutGetAllItemIds, layoutGetAllItems, layoutGetAxisIdDimensionIdsObject, layoutGetDimension, layoutGetDimensionIdItemIdsObject, layoutGetDimensionItems, layoutHasDataDimension, layoutHasDimension, layoutHasDynamicDimension, layoutHasPeriodDimension, layoutReplaceDimension, ouIdHelper, visTypeDisplayNames, visTypeIcons };
