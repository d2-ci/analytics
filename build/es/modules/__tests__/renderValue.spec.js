...
describe('renderValue', () => {
  tests.forEach(t => {
    const testname = `valueType: ${t.valueType}, value: ${t.value}, dgs: ${t.dgs}, round: ${t.round}, isPercent: ${[NUMBER_TYPE_ROW_PERCENTAGE, NUMBER_TYPE_COLUMN_PERCENTAGE].includes(t.numberType)}`;
    it(testname, () => {
