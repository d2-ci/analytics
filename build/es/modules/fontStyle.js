...
import i18n from '../locales/index.js'; // Font styles
...
export const FONT_STYLE_REGRESSION_LINE_LABEL = 'regressionLineLabel'; // Options
...
export const FONT_STYLE_OPTION_TEXT_ALIGN = 'textAlign'; // Text align

export const TEXT_ALIGN_LEFT = 'LEFT';
export const TEXT_ALIGN_CENTER = 'CENTER';
export const TEXT_ALIGN_RIGHT = 'RIGHT'; // Tiers
...
export const mergeFontStyleWithDefault = (fontStyle, fontStyleKey) => ({ ...defaultFontStyle[fontStyleKey],
  ...fontStyle
