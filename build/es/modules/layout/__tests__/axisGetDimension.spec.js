...
describe('axisGetDimension', () => {
  it('should return the dimension specified by id', () => {
    ...
    expect(axisGetDimension(TEST_AXIS_COLUMNS, dimensionGetId(columnDimension))).toEqual(columnDimension);
    expect(axisGetDimension(TEST_AXIS_COLUMNS, dimensionGetId(rowDimension))).not.toEqual(columnDimension);
  });
});