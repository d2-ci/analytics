...
describe('layoutReplaceDimension', () => {
  it('replaces the dimension in the provided layout', () => {
    const updatedLayout = layoutReplaceDimension(TEST_LAYOUT, DIMENSION_ID_ORGUNIT, newOuDimensions);
  ...
  it('returns layout unchanged if dimension not found', () => {
    const updatedLayout = layoutReplaceDimension(TEST_LAYOUT, 'non-existing-dimension', newOuDimensions);
