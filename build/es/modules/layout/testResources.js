...
import { AXIS_ID_ROWS, AXIS_ID_COLUMNS, AXIS_ID_FILTERS, DEFAULT_AXIS_IDS } from './axis.js';
import { DIMENSION_PROP_ID, DIMENSION_PROP_ITEMS } from './dimension.js';
import { ITEM_PROP_ID } from './item.js'; // Items
...
export const TEST_ITEMS_IN_LAYOUT = [TEST_ITEM_1, TEST_ITEM_2, TEST_ITEM_3, TEST_ITEM_4, TEST_ITEM_5]; // Dimensions
...
export const TEST_DIMENSIONS_IN_LAYOUT = [TEST_DIMENSION_1, TEST_DIMENSION_2, TEST_DIMENSION_3, TEST_DIMENSION_4]; // Axes
...
export const TEST_AXES_IN_LAYOUT = [TEST_AXIS_COLUMNS, TEST_AXIS_ROWS, TEST_AXIS_FILTERS];
export const TEST_AXIS_IDS_IN_LAYOUT = DEFAULT_AXIS_IDS; // Layout
