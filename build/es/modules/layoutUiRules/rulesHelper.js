import { getMaxNumberOfItemsPerAxisByVisType, getMaxNumberOfDimsPerAxisByVisType, getMinNumberOfDimsPerAxisByVisType, getLockedDimsByVisType } from './rules.js'; // Selectors

export { getAvailableAxesByVisType, getDisallowedDimsByVisType } from './rules.js';
export const getAxisMaxNumberOfItemsByVisType = (visType, axisId) => getMaxNumberOfItemsPerAxisByVisType(visType)[axisId];
