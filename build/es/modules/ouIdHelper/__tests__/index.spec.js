...
describe('ouIdHelper', () => {
  describe('addGroupPrefix', () => {
    it('returns the id with the "OU_GROUP-" prefix', () => {
      expect(ouIdHelper.addGroupPrefix('fruit-group')).toEqual('OU_GROUP-fruit-group');
    });
    it('returns the id with the "OU_GROUP-" prefix when id already contained GROUP-', () => {
      expect(ouIdHelper.addGroupPrefix('OU_GROUP-fruit-group')).toEqual('OU_GROUP-fruit-group');
    });
  });
  describe('addLevelPrefix', () => {
    ...
    it('returns the id with the "LEVEL-" prefix when id already contained LEVEL-', () => {
      expect(ouIdHelper.addLevelPrefix('LEVEL-2nd-floor')).toEqual('LEVEL-2nd-floor');
    });
  });
  describe('removePrefix', () => {
    ...
    it('returns the uid of a group-id', () => {
      expect(ouIdHelper.removePrefix('OU_GROUP-fruit-group')).toEqual('fruit-group');
    });
