  ...
  describe('applyBooleanHandler', () => {
    describe('yes/no', () => {
      it('should return the transformed response', () => {
        expect(applyBooleanHandler(booleanResponseOrg, headerIndex)).toEqual(booleanResponseHideNa);
      });
    });
    describe('yes only', () => {
      it('should return the transformed response', () => {
        expect(applyBooleanHandler(yesOnlyResponseOrg, headerIndex)).toEqual(yesOnlyResponseHideNa);
      });
    });
  });
});