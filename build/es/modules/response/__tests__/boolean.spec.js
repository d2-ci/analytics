  ...
  describe('applyBooleanHandler', () => {
    describe('boolean', () => {
      it('should return the transformed response', () => {
        expect(applyBooleanHandler(booleanResponseOrg, headerIndex)).toEqual(booleanResponse);
      });
    });
    describe('yes only', () => {
      it('should return the transformed response', () => {
        expect(applyBooleanHandler(yesOnlyResponseOrg, headerIndex)).toEqual(yesOnlyResponse);
      });
    });
  });
});