...
describe('response', () => {
  describe('getItemFormatterByValueType', () => {
    it('should return the correct formatter and format correctly', () => {
      ...
      expect(getItemFormatterByValueType('AGE')('1985-01-01 00:00:00.0')).toBe('1985-01-01');
      expect(getItemFormatterByValueType('DATE')('2023-01-01 00:00:00.0')).toBe('2023-01-01');
      expect(getItemFormatterByValueType('DATETIME')('2023-01-01 12:00:00.0')).toBe('2023-01-01 12:00');
