...
import { VIS_TYPE_GAUGE, VIS_TYPE_PIE, isTwoCategoryChartType } from '../../../../modules/visTypes.js';
...
export const isRegressionIneligible = type => arrayContains([VIS_TYPE_GAUGE, VIS_TYPE_PIE], type);
...
function getDefaultTrendLines(layout, series, isStacked) {
  ...
  if (isStacked) {
    newSeries.push(...series, Object.assign({}, getRegressionObj(getStackedData(series, layout), layout.regressionType)));
  } else {
    series.forEach(seriesObj => {
      newSeries.push(seriesObj, Object.assign({}, getRegressionObj(seriesObj.data, layout.regressionType), {
        name: seriesObj.name ? i18n.t('{{seriesName}} (trend)', {
