...
import { FONT_STYLE_OPTION_FONT_SIZE, FONT_STYLE_OPTION_TEXT_COLOR, FONT_STYLE_OPTION_BOLD, FONT_STYLE_OPTION_ITALIC, FONT_STYLE_OPTION_TEXT_ALIGN } from '../../../../modules/fontStyle.js';
...
const getTitleStyle = (fontStyle, titleType, visType) => fontStyle ? {
  align: getTextAlignOption(fontStyle[FONT_STYLE_OPTION_TEXT_ALIGN], titleType, isVerticalType(visType)),
  margin: 15,
  style: {
...
export default function (title, fontStyle, titleType, visType) {
  return isString(title) ? Object.assign({}, getTitleStyle(fontStyle, titleType, visType), {
    text: title
  }) : {
    text: null
  };
