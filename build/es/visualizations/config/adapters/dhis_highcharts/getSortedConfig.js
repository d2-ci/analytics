...
function getDefaultSortedConfig(config, layout, stacked) {
  ...
  const series = config.series;
  const indexOrder = getIndexOrder(stacked ? getStackedData(series, layout) : (_series$0$data = (_series$ = series[0]) === null || _series$ === void 0 ? void 0 : _series$.data) !== null && _series$0$data !== void 0 ? _series$0$data : [], layout);
  const sortedConfig = Object.assign({}, config);
  if (categories) {
