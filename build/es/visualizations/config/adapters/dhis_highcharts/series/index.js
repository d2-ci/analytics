...
function getDefault(_ref) {
  ...
  series.forEach((seriesObj, index) => {
    ...
    seriesObj.yAxis = isDualAxisType(layout.type) && !axisHasRelativeItems(layout.columns) ? getAxisStringFromId(fullIdAxisMap[seriesObj.id]) : getAxisStringFromId(0); // custom names for "year over year" series
