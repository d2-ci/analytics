import { defaultFontStyle, FONT_STYLE_OPTION_BOLD, FONT_STYLE_OPTION_FONT_SIZE, FONT_STYLE_OPTION_ITALIC, FONT_STYLE_OPTION_TEXT_ALIGN, FONT_STYLE_OPTION_TEXT_COLOR, FONT_STYLE_VISUALIZATION_SUBTITLE, FONT_STYLE_VISUALIZATION_TITLE, mergeFontStyleWithDefault } from '../../../../../modules/fontStyle.js';
...
export const generateDVItem = (config, _ref) => {
  let {
    renderer,
    width,
    height,
  ...
  generateValueSVG({
    ...
    topMargin: TOP_MARGIN_FIXED + ((config.title ? parseInt(titleFontSize) : 0) + (config.subtitle ? parseInt(subtitleFontSize) : 0)) * 2.5
  });
};