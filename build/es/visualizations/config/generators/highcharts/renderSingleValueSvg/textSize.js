...
import { ACTUAL_NUMBER_HEIGHT_FACTOR, ACTUAL_TEXT_WIDTH_FACTOR, ICON_PADDING_FACTOR, TEXT_SIZE_CONTAINER_HEIGHT_FACTOR, TEXT_SIZE_MAX_THRESHOLD, TEXT_WIDTH_CONTAINER_WIDTH_FACTOR } from './constants.js';
...
export const getTextHeightForNumbers = textSize => textSize * ACTUAL_NUMBER_HEIGHT_FACTOR;
export const getIconPadding = textSize => Math.round(textSize * ICON_PADDING_FACTOR);
export const getTextSize = (formattedValue, containerWidth, containerHeight, showIcon) => {
