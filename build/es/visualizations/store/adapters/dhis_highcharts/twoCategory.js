import getTwoCategorySplitSerieData from '../../../config/adapters/dhis_highcharts/getTwoCategorySplitSerieData.js'; // 1 series, 2 categories
...
export default function (acc, series, categories, idValueMap, metaData) {
  series[0].forEach(seriesItemId => {
    ...
    const serieData = getTwoCategorySplitSerieData(groupedData); // avoid a list of null values
