...
describe('getFilterText', () => {
  ...
  it('summarizes ou levels and groups', () => {
    ...
    expect(getFilterText(filters, metaData)).toEqual('Clinics, Hospital - Fruit and Veggies groups in Sierra Leone - Second floor levels in Sierra Leone');
  });
  describe('metadata is missing', () => {
    it('uses uids in the title', () => {
      ...
      expect(getFilterText(filters, metaData)).toEqual('Clinics, Hospital - Facility Ownership: _mission_, _NGO_');
    });
  });
