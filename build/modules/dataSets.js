...
var DATA_SETS_CONSTANTS = [{
  id: REPORTING_RATE,
  name: function name() {
    return _d2I18n.default.t('Reporting rate');
  }
}, {
  id: REPORTING_RATE_ON_TIME,
  name: function name() {
    return _d2I18n.default.t('Reporting rate on time');
  }
}, {
  id: ACTUAL_REPORTS,
  name: function name() {
    return _d2I18n.default.t('Actual reports');
  }
}, {
  id: ACTUAL_REPORTS_ON_TIME,
  name: function name() {
    return _d2I18n.default.t('Actual reports on time');
  }
}, {
  id: EXPECTED_REPORTS,
  name: function name() {
    return _d2I18n.default.t('Expected reports');
  }
}];
