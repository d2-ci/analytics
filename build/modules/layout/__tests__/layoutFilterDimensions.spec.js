...
describe('layoutFilterDimensions', function () {
  it('should return a copy of the layout without the specified dimensions', function () {
    var idsToFilter = _testResources.TEST_LAYOUT[_axis.AXIS_NAME_FILTERS].map(function (dimension) {
    ...
    var expectedState = Object.assign({}, _testResources.TEST_LAYOUT, (0, _defineProperty2.default)({}, _axis.AXIS_NAME_FILTERS, _axis.AXIS.defaultValue));
