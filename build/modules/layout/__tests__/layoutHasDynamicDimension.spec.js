...
describe('layoutHasDynamicDimension', function () {
  it('should return true if a dynamic dimension id is found in the layout, otherwise false', function () {
    ...
    var layoutWithoutDynamicDimension = _objectSpread(_objectSpread({}, _testResources.TEST_LAYOUT), {}, (0, _defineProperty2.default)({}, _axis.AXIS_ID_FILTERS, _axis.AXIS.defaultValue));
