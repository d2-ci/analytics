...
var TEST_DIMENSION_1 = (_TEST_DIMENSION_ = {}, (0, _defineProperty2.default)(_TEST_DIMENSION_, _dimension.DIMENSION_PROP_ID.name, _fixedDimensions.DIMENSION_ID_DATA), (0, _defineProperty2.default)(_TEST_DIMENSION_, _dimension.DIMENSION_PROP_ITEMS.name, [TEST_ITEM_1, TEST_ITEM_2]), _TEST_DIMENSION_);
exports.TEST_DIMENSION_1 = TEST_DIMENSION_1;
var TEST_DIMENSION_2 = (_TEST_DIMENSION_2 = {}, (0, _defineProperty2.default)(_TEST_DIMENSION_2, _dimension.DIMENSION_PROP_ID.name, _fixedDimensions.DIMENSION_ID_PERIOD), (0, _defineProperty2.default)(_TEST_DIMENSION_2, _dimension.DIMENSION_PROP_ITEMS.name, [TEST_ITEM_3]), _TEST_DIMENSION_2);
exports.TEST_DIMENSION_2 = TEST_DIMENSION_2;
var TEST_DIMENSION_3 = (_TEST_DIMENSION_3 = {}, (0, _defineProperty2.default)(_TEST_DIMENSION_3, _dimension.DIMENSION_PROP_ID.name, _fixedDimensions.DIMENSION_ID_ORGUNIT), (0, _defineProperty2.default)(_TEST_DIMENSION_3, _dimension.DIMENSION_PROP_ITEMS.name, [TEST_ITEM_4]), _TEST_DIMENSION_3);
...
var TEST_DIMENSION_EMPTY_1 = (_TEST_DIMENSION_EMPTY = {}, (0, _defineProperty2.default)(_TEST_DIMENSION_EMPTY, _dimension.DIMENSION_PROP_ID.name, _fixedDimensions.DIMENSION_ID_DATA), (0, _defineProperty2.default)(_TEST_DIMENSION_EMPTY, _dimension.DIMENSION_PROP_ITEMS.name, []), _TEST_DIMENSION_EMPTY);
...
var TEST_DIMENSION_INVALID_ITEMS_1 = (_TEST_DIMENSION_INVAL2 = {}, (0, _defineProperty2.default)(_TEST_DIMENSION_INVAL2, _dimension.DIMENSION_PROP_ID.name, _fixedDimensions.DIMENSION_ID_DATA), (0, _defineProperty2.default)(_TEST_DIMENSION_INVAL2, _dimension.DIMENSION_PROP_ITEMS.name, 'This is not an array'), _TEST_DIMENSION_INVAL2);
...
var TEST_AXIS_NAMES_IN_LAYOUT = _axis.AXIS_NAMES; // Layout

exports.TEST_AXIS_NAMES_IN_LAYOUT = TEST_AXIS_NAMES_IN_LAYOUT;
var TEST_LAYOUT = (_TEST_LAYOUT = {}, (0, _defineProperty2.default)(_TEST_LAYOUT, _axis.AXIS_NAME_COLUMNS, TEST_AXIS_COLUMNS), (0, _defineProperty2.default)(_TEST_LAYOUT, _axis.AXIS_NAME_ROWS, TEST_AXIS_ROWS), (0, _defineProperty2.default)(_TEST_LAYOUT, _axis.AXIS_NAME_FILTERS, TEST_AXIS_FILTERS), _TEST_LAYOUT);
