...
var getTransformedExtraOptions = function getTransformedExtraOptions(extraOptions) {
  return _objectSpread(_objectSpread({}, extraOptions), {}, {
...
function _default(_ref) {
  ...
  var stacked = (0, _visTypes.isStacked)(_layout.type);
  var config = {
    // type etc
    ...
    // series
    series: (0, _series.default)(series.slice(), store, _layout, stacked, _extraOptions),
    // legend
  ...
  if ((0, _isString.default)(_layout.regressionType) && _layout.regressionType !== 'NONE' && !(0, _addTrendLines.isRegressionIneligible)(_layout.type)) {
    config.series = (0, _addTrendLines.default)(_layout.regressionType, config.series, stacked);
