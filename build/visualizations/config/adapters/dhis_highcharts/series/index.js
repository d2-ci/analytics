...
function getDefault(series, layout, isStacked, extraOptions) {
  ...
  series.forEach(function (seriesObj, index) {
    ...
    seriesObj.color = (0, _type.isYearOverYear)(layout.type) ? extraOptions.colors[index] : idColorMap[seriesObj.id]; // axis number

    seriesObj.yAxis = (0, _type.isDualAxis)(layout.type) ? fullIdAxisMap[seriesObj.id] : 0; // custom names for "year over year" series
