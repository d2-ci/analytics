...
var generateValueSVG = function generateValueSVG(value, legendSet, y) {
  var textSize = 300;
  var defaultFillColor = '#000000';
  ...
  var fillColor = legendSet ? (0, _legends.getColorByValueFromLegendSet)(legendSet, value) : defaultFillColor;
...
var generateDashboardItem = function generateDashboardItem(config, legendSet) {
...
var generateDVItem = function generateDVItem(config, legendSet, parentEl) {
