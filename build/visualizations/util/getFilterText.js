...
function _default(filters, metaData) {
  ...
  filters.forEach(function (filter) {
    ...
    if ((0, _dimensionIs.dimensionIs)(filter, _fixedDimensions.DIMENSION_ID_ORGUNIT) && items.some(function (_ref) {
      var id = _ref.id;
      ...
      if ((0, _dimensionIs.dimensionIs)(filter, _fixedDimensions.DIMENSION_ID_PERIOD)) {
